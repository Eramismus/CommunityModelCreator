...
within ResidentialCommunityUK.SemiDetached_7.SemiDetached_7_Models;
model SemiDetached_7_House
  ...
  IBPSA.BoundaryConditions.SolarIrradiation.DiffusePerez HDifTil[3](
    ...
    azi = {2.893204917137732, -0.24838773645206152, 1.322408590342835})
  ...
  thermalZoneFourElements(
    ...
    ratioWinConRad=0.03,
    nExt=1,
    RExt={0.001250248281150974},
    CExt={12635235.7355701},
    alphaRad=5.979473494416848,
    ...
    ARoof=56.82889318504067,
    alphaRoof=4.3,
    nRoof=1,
    RRoof={0.0059452910340769055},
    RRoofRem=0.09084821052305439,
    CRoof={1455746.8860205028},
    ...
    nOrientations=3,
    AWin={3.8939959060573335, 6.023386582059734, 0.7239071058033024},
    ATransparent={3.8939959060573335, 6.023386582059734, 0.7239071058033024},
    AExt={26.192841103322493, 23.934066916030826, 34.93965000799736})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  IBPSA.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=3,
    wfGro=0.0,
    wfWall={0.337318280538744, 0.3148304334761818, 0.34785128598507425},
    wfWin={0.3659327069044403, 0.5660391561471123, 0.06802813694844732},
    withLongwave=true,
    aExt=0.9192037479675067,
    alphaWallOut=14.0,
    alphaRad=5.7,
  ...
  IBPSA.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=19.7*85.06655802735068)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://ResidentialCommunityUK/SemiDetached_7/SemiDetached_7_Models/InternalGains_SemiDetached_7House.mat"),
    columns={2,3,4})
  ...
  IBPSA.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007 eqAirTempVDI(
    ...
    alphaRad=5.7,
    n=4,
    wfWall={0.27272727272727276, 0.2272727272727273, 0.27272727272727276, 0.2272727272727273},
    wfWin={0, 0, 0, 0},
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant alphaRoof(k=1352.527657803968)
  ...
  IBPSA.BoundaryConditions.SolarIrradiation.DirectTiltedSurface HDirTilRoof[4](
    ...
    each lat = 0.886452727088,
    azi={1.322408590342835, -0.24838773645206152, -1.819184063246958, 2.893204917137732})
