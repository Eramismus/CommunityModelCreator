...
within ResidentialCommunityUK.SemiDetached_11.SemiDetached_11_Models;
model SemiDetached_11_House
  "This is the simulation model of House within building SemiDetached_11 with traceable ID None"
  ...
  IBPSA.BoundaryConditions.SolarIrradiation.DiffusePerez HDifTil[3](
    ...
    azi = {-1.5632418829259977, 1.5783507706637954, 0.007554443868899053})
  ...
  thermalZoneFourElements(
    ...
    VAir=218.20803549284,
    alphaExt=3.0,
    alphaWin=2.9999999999999996,
    gWin=0.84,
    ratioWinConRad=0.03,
    nExt=1,
    RExt={0.0012068142288267248},
    CExt={13101159.195399385},
    alphaRad=5.962481328313458,
    AInt=124.13996522023399,
    alphaInt=3.0,
    nInt=1,
    RInt={0.0007899510609428215},
    CInt={7353328.68715425},
    RWin=0.019884690337533775,
    RExtRem=0.018486496513027736,
    AFloor=41.612782057022024,
    alphaFloor=3.0,
    nFloor=1,
    RFloor={0.0025590837622643694},
    RFloorRem=0.003906420483016393,
    CFloor={16026336.797806887},
    ARoof=54.14172041786036,
    alphaRoof=4.3,
    nRoof=1,
    RRoof={0.006547825156682442},
    RRoofRem=0.09689395637997505,
    CRoof={1420187.1972937235},
    ...
    nOrientations=3,
    AWin={5.832669030554417, 3.56295471560271, 0.6623654206384806},
    ATransparent={5.832669030554417, 3.56295471560271, 0.6623654206384806},
    AExt={24.759368163213235, 27.101759626836603, 36.233076498387156})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  IBPSA.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=3,
    wfGro=0.0,
    wfWall={0.31434803106720666, 0.3368944633055043, 0.3487575056272893},
    wfWin={0.5799040875694895, 0.3542412560320781, 0.06585465639843245},
    withLongwave=true,
    aExt=0.9195747965780702,
    alphaWallOut=14.0,
  ...
  IBPSA.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=19.7*88.094204288437)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant alphaWin(k=11.399999999999999*10.057989166795608)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://ResidentialCommunityUK/SemiDetached_11/SemiDetached_11_Models/InternalGains_SemiDetached_11House.mat"),
    columns={2,3,4})
  ...
  IBPSA.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007 eqAirTempVDI(
    ...
    n=4,
    wfWall={0.2727272727272728, 0.22727272727272724, 0.2727272727272728, 0.22727272727272724},
    wfWin={0, 0, 0, 0},
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant alphaRoof(k=1288.5729459450768)
  ...
  IBPSA.BoundaryConditions.SolarIrradiation.DirectTiltedSurface HDirTilRoof[4](
    ...
    each lat = 0.886452727088,
    azi={0.007554443868899053, -1.5632418829259977, -3.1340382097208943, 1.5783507706637954})
