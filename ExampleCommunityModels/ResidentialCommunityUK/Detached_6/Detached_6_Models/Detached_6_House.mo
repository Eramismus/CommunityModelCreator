...
within ResidentialCommunityUK.Detached_6.Detached_6_Models;
model Detached_6_House
  ...
  IBPSA.BoundaryConditions.SolarIrradiation.DiffusePerez HDifTil[4](
    ...
    azi = {-1.6048073275712842, -0.03401100077638778, 3.1075816528134057, 1.536785326018509})
  ...
  thermalZoneFourElements(
    ...
    nExt=1,
    RExt={0.000886262914419696},
    CExt={17851262.07397216},
    ...
    ARoof=85.40859787317446,
    alphaRoof=4.3,
    nRoof=1,
    RRoof={0.00393519149096972},
    RRoofRem=0.06034484030830175,
    CRoof={2182242.9713804414},
    ...
    nOrientations=4,
    AWin={0.6110615189562245, 7.090643352474341, 4.5513227681261235, 0.0},
    ATransparent={0.6110615189562245, 7.090643352474341, 4.5513227681261235, 0.0},
    AExt={35.34857990955646, 23.69223745874132, 26.069400301328947, 35.34857990955646})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  IBPSA.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=4,
    wfGro=0.0,
    wfWall={0.30019820162818844, 0.16340295377853709, 0.23620064296508622, 0.30019820162818844},
    wfWin={0.049870247332465215, 0.5786850043154623, 0.37144474835207253, 0.0},
    withLongwave=true,
    aExt=0.9185637244627615,
    alphaWallOut=14.0,
    alphaRad=5.7,
    alphaWinOut=5.7,
  ...
  IBPSA.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=19.700000000000003*120.45879757918318)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://ResidentialCommunityUK/Detached_6/Detached_6_Models/InternalGains_Detached_6House.mat"),
    columns={2,3,4})
  ...
  IBPSA.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007 eqAirTempVDI(
    ...
    alphaRad=5.7,
    n=4,
    wfWall={0.30654761904761907, 0.193452380952381, 0.30654761904761907, 0.193452380952381},
    wfWin={0, 0, 0, 0},
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant alphaRoof(k=2032.7246293815522)
  ...
  IBPSA.BoundaryConditions.SolarIrradiation.DirectTiltedSurface HDirTilRoof[4](
    ...
    each lat = 0.886452727088,
    azi={-1.6048073275712842, -0.03401100077638778, 1.536785326018509, 3.1075816528134057})
