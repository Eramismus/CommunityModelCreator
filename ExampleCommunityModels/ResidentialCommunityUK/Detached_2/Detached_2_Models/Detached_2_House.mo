...
within ResidentialCommunityUK.Detached_2.Detached_2_Models;
model Detached_2_House
  ...
  IBPSA.BoundaryConditions.SolarIrradiation.DiffusePerez HDifTil[4](
    ...
    azi = {-0.5083582702001366, 1.06243805659476, 2.6332343833896568, -2.079154596995033})
  ...
  thermalZoneFourElements(
    ...
    nExt=1,
    RExt={0.0007383289651536422},
    CExt={21344907.142895572},
    alphaRad=5.953551361181983,
    ...
    ARoof=85.14124546674628,
    alphaRoof=4.3,
    nRoof=1,
    RRoof={0.004428319383307474},
    RRoofRem=0.06293452378557957,
    CRoof={2302970.030390115},
    ...
    nOrientations=4,
    AWin={7.291843450307002, 0.0, 4.8279235640199465, 0.6481979979743825},
    ATransparent={7.291843450307002, 0.0, 4.8279235640199465, 0.6481979979743825},
    AExt={28.336049871930044, 41.95565203972405, 30.857700796950212, 41.95565203972405})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  IBPSA.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=4,
    wfGro=0.0,
    wfWall={0.17269711477049868, 0.2983135156942067, 0.23067585384108796, 0.2983135156942067},
    wfWin={0.5711045921007503, 0.0, 0.3781278817233968, 0.05076752617585295},
    withLongwave=true,
    aExt=0.920373505656927,
  ...
  IBPSA.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=19.700000000000003*143.1050547483283)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://ResidentialCommunityUK/Detached_2/Detached_2_Models/InternalGains_Detached_2House.mat"),
    columns={2,3,4})
  ...
  IBPSA.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007 eqAirTempVDI(
    ...
    n=4,
    wfWall={0.1934523809523809, 0.30654761904761907, 0.1934523809523809, 0.30654761904761907},
    wfWin={0, 0, 0, 0},
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant alphaRoof(k=2026.3616421085612)
  ...
  IBPSA.BoundaryConditions.SolarIrradiation.DirectTiltedSurface HDirTilRoof[4](
    ...
    each lat = 0.886452727088,
    azi={2.6332343833896568, -2.079154596995033, -0.5083582702001366, 1.06243805659476})
