...
within ResidentialCommunityUK.SemiDetached_5.SemiDetached_5_Models;
model SemiDetached_5_House
  ...
  IBPSA.BoundaryConditions.SolarIrradiation.DiffusePerez HDifTil[3](
    ...
    azi = {-1.2705072271233229, 0.3002890996715735, 1.87108542646647})
  ...
  thermalZoneFourElements(
    ...
    nExt=1,
    RExt={0.001214949936584471},
    CExt={12986657.64772922},
    ...
    ARoof=52.85946929609037,
    alphaRoof=4.3,
    nRoof=1,
    RRoof={0.0061211248069909865},
    RRoofRem=0.09631422022729053,
    CRoof={1325766.85274827},
    ...
    nOrientations=3,
    AWin={5.7776015739270985, 0.6445959806900478, 3.4673704536754206},
    ATransparent={5.7776015739270985, 0.6445959806900478, 3.4673704536754206},
    AExt={24.55423504501297, 35.911588302358965, 26.87584297936397})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  IBPSA.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=3,
    wfGro=0.0,
    wfWall={0.3126440403570342, 0.35195854654868636, 0.3353974130942796},
    wfWin={0.5842117238167011, 0.06517938702171251, 0.3506088891615865},
    withLongwave=true,
    aExt=0.9194849727670141,
  ...
  IBPSA.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=19.699999999999996*87.3416663267359)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://ResidentialCommunityUK/SemiDetached_5/SemiDetached_5_Models/InternalGains_SemiDetached_5House.mat"),
    columns={2,3,4})
  ...
  IBPSA.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007 eqAirTempVDI(
    ...
    n=4,
    wfWall={0.22727272727272727, 0.2727272727272727, 0.2727272727272727, 0.22727272727272727},
    wfWin={0, 0, 0, 0},
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant alphaRoof(k=1258.0553692469505)
  ...
  IBPSA.BoundaryConditions.SolarIrradiation.DirectTiltedSurface HDirTilRoof[4](
    ...
    each lat = 0.886452727088,
    azi={1.87108542646647, 0.3002890996715735, -2.8413035539182196, -1.2705072271233229})
