...
within ResidentialCommunityUK.Terrace_5.Terrace_5_Models;
model Terrace_5_House
  ...
  IBPSA.BoundaryConditions.SolarIrradiation.DiffusePerez HDifTil[2](
    ...
    azi = {1.7830106244211918, -1.358582029168601})
  ...
  thermalZoneFourElements(
    ...
    ratioWinConRad=0.03,
    nExt=1,
    RExt={0.00230936755100901},
    CExt={6916170.175793051},
    alphaRad=5.956633535694695,
    ...
    ARoof=42.57733900082129,
    alphaRoof=4.3,
    nRoof=1,
    RRoof={0.008133575014760624},
    RRoofRem=0.12224864165502132,
    CRoof={1103991.9029387198},
    ...
    nOrientations=2,
    AWin={3.092467881249907, 6.579702158963139},
    ATransparent={3.092467881249907, 6.579702158963139},
    AExt={24.96559280825305, 21.46362295717118})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  IBPSA.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=2,
    wfGro=0.0,
    wfWall={0.6318185141387058, 0.3681814858612941},
    wfWin={0.31972844443311604, 0.6802715555668839},
    withLongwave=true,
    aExt=0.9201096757197014,
  ...
  IBPSA.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=19.699999999999996*46.42921576542423)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://ResidentialCommunityUK/Terrace_5/Terrace_5_Models/InternalGains_Terrace_5House.mat"),
    columns={2,3,4})
  ...
  IBPSA.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007 eqAirTempVDI(
    ...
    alphaRad=5.7,
    n=4,
    wfWall={0.12581417111935222, 0.12581417111935222, 0.3741858288806478, 0.3741858288806478},
    wfWin={0, 0, 0, 0},
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant alphaRoof(k=1013.3406682195464)
  ...
  IBPSA.BoundaryConditions.SolarIrradiation.DirectTiltedSurface HDirTilRoof[4](
    ...
    each lat = 0.886452727088,
    azi={-2.929378355963498, 0.2122142976262954, -1.358582029168601, 1.7830106244211918})
