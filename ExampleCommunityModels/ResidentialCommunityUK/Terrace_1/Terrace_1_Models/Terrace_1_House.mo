...
within ResidentialCommunityUK.Terrace_1.Terrace_1_Models;
model Terrace_1_House
  ...
  IBPSA.BoundaryConditions.SolarIrradiation.DiffusePerez HDifTil[2](
    ...
    azi = {-3.018810575624228, 0.12278207796556499})
  ...
  thermalZoneFourElements(
    ...
    ratioWinConRad=0.03,
    nExt=1,
    RExt={0.002329809886850921},
    CExt={6849800.7565332595},
    alphaRad=5.967596388239628,
    ...
    ARoof=42.16819539265857,
    alphaRoof=4.300000000000001,
    nRoof=1,
    RRoof={0.008212492317192318},
    RRoofRem=0.12343477850232959,
    CRoof={1093383.1791163587},
    ...
    nOrientations=2,
    AWin={7.020816488750059, 3.579709673187636},
    ATransparent={7.020816488750059, 3.579709673187636},
    AExt={21.257369951534262, 24.741447349000204})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  IBPSA.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=2,
    wfGro=0.0,
    wfWall={0.37004505987205394, 0.6299549401279461},
    wfWin={0.662308302578323, 0.3376916974216771},
    withLongwave=true,
    aExt=0.9200171346363146,
  ...
  IBPSA.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=19.7*45.99881730053447)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://ResidentialCommunityUK/Terrace_1/Terrace_1_Models/InternalGains_Terrace_1House.mat"),
    columns={2,3,4})
  ...
  IBPSA.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007 eqAirTempVDI(
    ...
    n=4,
    wfWall={0.3741858288806478, 0.12581417111935217, 0.12581417111935217, 0.3741858288806478},
    wfWin={0, 0, 0, 0},
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant alphaRoof(k=1003.6030503452739)
  ...
  IBPSA.BoundaryConditions.SolarIrradiation.DirectTiltedSurface HDirTilRoof[4](
    ...
    each lat = 0.886452727088,
    azi={-3.018810575624228, -1.4480142488293315, 1.693578404760462, 0.12278207796556499})
