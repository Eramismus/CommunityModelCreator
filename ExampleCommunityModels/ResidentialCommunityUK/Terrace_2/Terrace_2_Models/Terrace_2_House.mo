...
within ResidentialCommunityUK.Terrace_2.Terrace_2_Models;
model Terrace_2_House
  ...
  IBPSA.BoundaryConditions.SolarIrradiation.DiffusePerez HDifTil[2](
    ...
    azi = {-1.2090543938997529, 1.9325382596900407})
  ...
  thermalZoneFourElements(
    ...
    nExt=1,
    RExt={0.0023938470988529754},
    CExt={6647421.611515309},
    alphaRad=5.968457191591603,
    ...
    ARoof=40.9189582692284,
    alphaRoof=4.300000000000001,
    nRoof=1,
    RRoof={0.008463215960033363},
    RRoofRem=0.12720318596307012,
    CRoof={1060991.5900344127},
    ...
    nOrientations=2,
    AWin={6.961978210443037, 3.5147186578862466},
    ATransparent={6.961978210443037, 3.5147186578862466},
    AExt={20.62761818144621, 24.05706459643966})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  IBPSA.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=2,
    wfGro=0.0,
    wfWall={0.37620723176153686, 0.6237927682384632},
    wfWin={0.6645203443357106, 0.33547965566428933},
    withLongwave=true,
    aExt=0.919723547948577,
  ...
  IBPSA.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=19.7*44.68468277788587)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://ResidentialCommunityUK/Terrace_2/Terrace_2_Models/InternalGains_Terrace_2House.mat"),
    columns={2,3,4})
  ...
  IBPSA.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007 eqAirTempVDI(
    aExt=0.6,
    wfGro=0,
    alphaWallOut=18.100000000000005,
    alphaRad=5.7,
    n=4,
    wfWall={0.12581417111935217, 0.3741858288806478, 0.12581417111935217, 0.3741858288806478},
    wfWin={0, 0, 0, 0},
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant alphaRoof(k=973.871206807636)
  ...
  IBPSA.BoundaryConditions.SolarIrradiation.DirectTiltedSurface HDirTilRoof[4](
    ...
    each lat = 0.886452727088,
    azi={-2.779850720694649, 1.9325382596900407, 0.36174193289514395, -1.2090543938997529})
