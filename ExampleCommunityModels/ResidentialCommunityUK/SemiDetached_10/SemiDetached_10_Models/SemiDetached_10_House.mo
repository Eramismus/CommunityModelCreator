...
within ResidentialCommunityUK.SemiDetached_10.SemiDetached_10_Models;
model SemiDetached_10_House
  ...
  IBPSA.BoundaryConditions.SolarIrradiation.DiffusePerez HDifTil[3](
    ...
    azi = {0.46998410219890635, 2.0407804289938025, -1.1008122245959902})
  ...
  thermalZoneFourElements(
    ...
    nExt=1,
    RExt={0.0012267190838482207},
    CExt={12866017.211049862},
    ...
    ARoof=60.47164450619034,
    alphaRoof=4.3,
    nRoof=1,
    RRoof={0.005905653009221574},
    RRoofRem=0.0869672789242187,
    CRoof={1592015.4284910285},
    ...
    nOrientations=3,
    AWin={0.657518775203984, 3.5368839430840486, 5.817649286655529},
    ATransparent={0.657518775203984, 3.5368839430840486, 5.817649286655529},
    AExt={35.57775583440312, 26.641251747368976, 24.34122537326045})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  IBPSA.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=3,
    wfGro=0.0,
    wfWall={0.3507763767656066, 0.33595028560260426, 0.31327333763178916},
    wfWin={0.06567272871528501, 0.35326264199763174, 0.5810646292870832},
    withLongwave=true,
    aExt=0.9193900470383773,
    alphaWallOut=14.0,
  ...
  IBPSA.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=19.700000000000003*86.56023295503255)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://ResidentialCommunityUK/SemiDetached_10/SemiDetached_10_Models/InternalGains_SemiDetached_10House.mat"),
    columns={2,3,4})
  ...
  IBPSA.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007 eqAirTempVDI(
    ...
    alphaRad=5.699999999999999,
    n=4,
    wfWall={0.2272727272727273, 0.2272727272727273, 0.2727272727272727, 0.2727272727272727},
    wfWin={0, 0, 0, 0},
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant alphaRoof(k=1439.2251392473297)
  ...
  IBPSA.BoundaryConditions.SolarIrradiation.DirectTiltedSurface HDirTilRoof[4](
    ...
    each lat = 0.886452727088,
    azi={-1.1008122245959902, 2.0407804289938025, -2.671608551390887, 0.46998410219890635})
