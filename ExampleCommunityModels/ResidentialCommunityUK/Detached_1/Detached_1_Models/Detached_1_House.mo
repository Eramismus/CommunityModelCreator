...
within ResidentialCommunityUK.Detached_1.Detached_1_Models;
model Detached_1_House
  ...
  IBPSA.BoundaryConditions.SolarIrradiation.DiffusePerez HDifTil[4](
    ...
    azi = {-0.029334555381334417, -1.6001308821762315, 3.1122580982084584, 1.5414617714135619})
  ...
  thermalZoneFourElements(
    ...
    alphaExt=3.0000000000000018,
    alphaWin=3.0,
    gWin=0.8400000000000001,
    ratioWinConRad=0.030000000000000002,
    nExt=1,
    RExt={0.0007919732183002194},
    CExt={19902005.261845823},
    alphaRad=5.979960251059888,
    ...
    ARoof=81.06577441967212,
    alphaRoof=4.3,
    nRoof=1,
    RRoof={0.003927069803573564},
    RRoofRem=0.0624797023796439,
    CRoof={2017268.312834671},
    ...
    nOrientations=4,
    AWin={7.562896707024932, 0.6982276137118493, 5.20055532387201, 0.0},
    ATransparent={7.562896707024932, 0.6982276137118493, 5.20055532387201, 0.0},
    AExt={26.416313109213487, 39.22431017367886, 28.878233136656398, 39.22431017367886})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  IBPSA.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=4,
    wfGro=0.0,
    wfWall={0.1704690597116282, 0.298765324527002, 0.2320002912343678, 0.298765324527002},
    wfWin={0.5618092917590536, 0.05186779303513432, 0.3863229152058122, 0.0},
    withLongwave=true,
    aExt=0.9196996606623662,
    alphaWallOut=14.000000000000007,
    alphaRad=5.7,
  ...
  IBPSA.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=19.700000000000006*133.74316659322756)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://ResidentialCommunityUK/Detached_1/Detached_1_Models/InternalGains_Detached_1House.mat"),
    columns={2,3,4})
  ...
  IBPSA.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007 eqAirTempVDI(
    ...
    n=4,
    wfWall={0.30654761904761907, 0.19345238095238096, 0.30654761904761907, 0.19345238095238096},
    wfWin={0, 0, 0, 0},
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant alphaRoof(k=1929.3654311881962)
  ...
  IBPSA.BoundaryConditions.SolarIrradiation.DirectTiltedSurface HDirTilRoof[4](
    ...
    each lat = 0.886452727088,
    azi={-1.6001308821762315, -0.029334555381334417, 1.5414617714135619, 3.1122580982084584})
