...
within ResidentialCommunityUK.Detached_3.Detached_3_Models;
model Detached_3_House
  ...
  IBPSA.BoundaryConditions.SolarIrradiation.DiffusePerez HDifTil[4](
    ...
    azi = {1.8041637116322216, -1.3374289419575716, -2.908225268752468, 0.2333673848373249})
  ...
  thermalZoneFourElements(
    ...
    ratioWinConRad=0.03,
    nExt=1,
    RExt={0.0007930730571015245},
    CExt={19953991.292818703},
    ...
    ARoof=80.27320900099483,
    alphaRoof=4.300000000000001,
    nRoof=1,
    RRoof={0.003932536975974391},
    RRoofRem=0.06292919380624283,
    CRoof={1989414.320236947},
    ...
    nOrientations=4,
    AWin={0.7192434343784909, 0.0, 7.676757398343959, 5.357085853325614},
    ATransparent={0.7192434343784909, 0.0, 7.676757398343959, 5.357085853325614},
    AExt={39.330942854013145, 39.330942854013145, 26.49126040127149, 28.955512346877637})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  IBPSA.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=4,
    wfGro=0.0,
    wfWall={0.2994552369074159, 0.2994552369074159, 0.16706681819313443, 0.23402270799203395},
    wfWin={0.05229687347991005, 0.0, 0.5581843242602194, 0.3895188022598705},
    withLongwave=true,
    aExt=0.919727732602365,
    alphaWallOut=14.000000000000009,
  ...
  IBPSA.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=19.70000000000001*134.10865845617536)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://ResidentialCommunityUK/Detached_3/Detached_3_Models/InternalGains_Detached_3House.mat"),
    columns={2,3,4})
  ...
  IBPSA.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007 eqAirTempVDI(
    ...
    n=4,
    wfWall={0.19345238095238096, 0.306547619047619, 0.19345238095238096, 0.306547619047619},
    wfWin={0, 0, 0, 0},
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant alphaRoof(k=1910.5023742236772)
  ...
  IBPSA.BoundaryConditions.SolarIrradiation.DirectTiltedSurface HDirTilRoof[4](
    ...
    each lat = 0.886452727088,
    azi={0.2333673848373249, -1.3374289419575716, -2.908225268752468, 1.8041637116322216})
