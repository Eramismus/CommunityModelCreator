...
within ResidentialCommunityUK.Detached_4.Detached_4_Models;
model Detached_4_House
  ...
  IBPSA.BoundaryConditions.SolarIrradiation.DiffusePerez HDifTil[4](
    ...
    azi = {-2.843809318523785, 1.8685796618609047, 0.2977833350660081, -1.2730129917288884})
  ...
  thermalZoneFourElements(
    ...
    ratioWinConRad=0.03,
    nExt=1,
    RExt={0.0008253365878138318},
    CExt={19118657.558899608},
    ...
    ARoof=88.30146972255463,
    alphaRoof=4.3,
    nRoof=1,
    RRoof={0.0037753562227669},
    RRoofRem=0.05821307163149791,
    CRoof={2247169.4040611256},
    ...
    nOrientations=4,
    AWin={7.587544418359602, 0.70277696147403, 5.234439882803989, 0.0},
    ATransparent={7.587544418359602, 0.70277696147403, 5.234439882803989, 0.0},
    AExt={25.375637806355673, 37.74366966147001, 27.805178149701575, 37.74366966147001})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  IBPSA.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=4,
    wfGro=0.0,
    wfWall={0.16826521185995894, 0.2992122245807314, 0.23331033897857845, 0.2992122245807314},
    wfWin={0.5610113384640897, 0.05196224523500191, 0.3870264163009086, 0.0},
    withLongwave=true,
    aExt=0.919293388119128,
    alphaWallOut=14.0,
  ...
  IBPSA.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=19.7*128.66815527899726)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://ResidentialCommunityUK/Detached_4/Detached_4_Models/InternalGains_Detached_4House.mat"),
    columns={2,3,4})
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant alphaRoof(k=2101.5749793968007)
  ...
  IBPSA.BoundaryConditions.SolarIrradiation.DirectTiltedSurface HDirTilRoof[4](
    ...
    each lat = 0.886452727088,
    azi={1.8685796618609047, -2.843809318523785, -1.2730129917288884, 0.2977833350660081})
