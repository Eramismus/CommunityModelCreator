...
within ResidentialCommunityUK.Detached_8.Detached_8_Models;
model Detached_8_House
  ...
  IBPSA.BoundaryConditions.SolarIrradiation.DiffusePerez HDifTil[4](
    ...
    azi = {-1.8574612984304621, 2.8549276819542273, -0.2866649716355655, 1.284131355159331})
  ...
  thermalZoneFourElements(
    ...
    ratioWinConRad=0.03,
    nExt=1,
    RExt={0.0008998078465820425},
    CExt={17556146.21723161},
    ...
    ARoof=79.42015823852921,
    alphaRoof=4.3,
    nRoof=1,
    RRoof={0.0040803157095496536},
    RRoofRem=0.0641351928968464,
    CRoof={1993429.7474248516},
    ...
    nOrientations=4,
    AWin={7.614279722638773, 0.7077116264026388, 0.0, 5.271194370111608},
    ATransparent={7.614279722638773, 0.7077116264026388, 0.0, 5.271194370111608},
    AExt={23.297740384999006, 34.78730172055103, 34.78730172055103, 25.662628802903072})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  IBPSA.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=4,
    wfGro=0.0,
    wfWall={0.164298157512059, 0.30001667067708093, 0.30001667067708093, 0.23566850113377918},
    wfWin={0.560154174301476, 0.052063706111618986, 0.0, 0.3877821195869052},
    withLongwave=true,
    aExt=0.918378113484603,
    alphaWallOut=14.0,
    alphaRad=5.7,
    alphaWinOut=5.7,
  ...
  IBPSA.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=19.7*118.53497262900413)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://ResidentialCommunityUK/Detached_8/Detached_8_Models/InternalGains_Detached_8House.mat"),
    columns={2,3,4})
  ...
  IBPSA.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007 eqAirTempVDI(
    ...
    alphaRad=5.7,
    n=4,
    wfWall={0.306547619047619, 0.19345238095238093, 0.306547619047619, 0.19345238095238093},
    wfWin={0, 0, 0, 0},
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant alphaRoof(k=1890.199766076995)
  ...
  IBPSA.BoundaryConditions.SolarIrradiation.DirectTiltedSurface HDirTilRoof[4](
    ...
    each lat = 0.886452727088,
    azi={2.8549276819542273, 1.284131355159331, -0.2866649716355655, -1.8574612984304621})
