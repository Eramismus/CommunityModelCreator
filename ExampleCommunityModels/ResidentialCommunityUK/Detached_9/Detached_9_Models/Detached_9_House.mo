...
within ResidentialCommunityUK.Detached_9.Detached_9_Models;
model Detached_9_House
  ...
  IBPSA.BoundaryConditions.SolarIrradiation.DiffusePerez HDifTil[4](
    ...
    azi = {1.8863127389611118, -2.826076241423578, 0.3155164121662153, -1.2552799146286815})
  ...
  thermalZoneFourElements(
    ...
    nExt=1,
    RExt={0.0008983973417479272},
    CExt={17555403.470109925},
    ...
    ARoof=83.39582396251708,
    alphaRoof=4.3,
    nRoof=1,
    RRoof={0.0039236821183521635},
    RRoofRem=0.06126775779662096,
    CRoof={2103123.093908871},
    ...
    nOrientations=4,
    AWin={4.767037229611666, 0.6400233863542715, 0.0, 7.247554581216689},
    ATransparent={4.767037229611666, 0.6400233863542715, 0.0, 7.247554581216689},
    AExt={25.659463496026074, 34.78293411436809, 34.78293411436809, 23.294670591994077})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  IBPSA.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=4,
    wfGro=0.0,
    wfWall={0.23477284506472684, 0.29971113315209263, 0.29971113315209263, 0.16580488863108792},
    wfWin={0.37670345208702827, 0.050576281963655725, 0.0, 0.5727202659493159},
    withLongwave=true,
    aExt=0.91837664551914,
    alphaWallOut=14.0,
  ...
  IBPSA.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=19.700000000000003*118.52000231675633)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://ResidentialCommunityUK/Detached_9/Detached_9_Models/InternalGains_Detached_9House.mat"),
    columns={2,3,4})
  ...
  IBPSA.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007 eqAirTempVDI(
    ...
    alphaRad=5.7,
    n=4,
    wfWall={0.19345238095238096, 0.30654761904761907, 0.30654761904761907, 0.19345238095238096},
    wfWin={0, 0, 0, 0},
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant alphaRoof(k=1984.8206103079067)
