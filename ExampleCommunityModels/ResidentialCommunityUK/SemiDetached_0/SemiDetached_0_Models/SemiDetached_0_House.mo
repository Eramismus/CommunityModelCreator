...
within ResidentialCommunityUK.SemiDetached_0.SemiDetached_0_Models;
model SemiDetached_0_House
  ...
  IBPSA.BoundaryConditions.SolarIrradiation.DiffusePerez HDifTil[3](
    ...
    azi = {-0.970097339377923, 0.6006989874169736, 2.1714953142118696})
  ...
  thermalZoneFourElements(
    ...
    alphaExt=2.999999999999999,
    alphaWin=3.000000000000001,
    gWin=0.8400000000000001,
    ratioWinConRad=0.03,
    nExt=1,
    RExt={0.0013938088694194404},
    CExt={11299244.657253878},
    alphaRad=5.980917898091004,
    ...
    ARoof=55.54210316516641,
    alphaRoof=4.3,
    nRoof=1,
    RRoof={0.005768366452809489},
    RRoofRem=0.09137561273379656,
    CRoof={1386404.4522867382},
    ...
    nOrientations=3,
    AWin={5.876247682575615, 0.6764275961510533, 3.638597092141416},
    ATransparent={5.876247682575615, 0.6764275961510533, 3.638597092141416},
    AExt={21.56698221327127, 31.22991362991942, 23.58592982043001})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  IBPSA.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=3,
    wfGro=0.0,
    wfWall={0.3160587487557339, 0.34554382770449144, 0.33839742353977487},
    wfWin={0.5765960783633812, 0.06637322323801613, 0.35703069839860274},
    withLongwave=true,
    aExt=0.917976354736541,
    alphaWallOut=13.999999999999998,
  ...
  IBPSA.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=19.699999999999996*76.38282566362071)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://ResidentialCommunityUK/SemiDetached_0/SemiDetached_0_Models/InternalGains_SemiDetached_0House.mat"),
    columns={2,3,4})
  ...
  IBPSA.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007 eqAirTempVDI(
    ...
    n=4,
    wfWall={0.27272727272727276, 0.2272727272727273, 0.2272727272727273, 0.27272727272727276},
    wfWin={0, 0, 0, 0},
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant alphaRoof(k=1321.9020553309606)
  ...
  IBPSA.BoundaryConditions.SolarIrradiation.DirectTiltedSurface HDirTilRoof[4](
    ...
    each lat = 0.886452727088,
    azi={-2.54089366617282, 2.1714953142118696, -0.970097339377923, 0.6006989874169736})
