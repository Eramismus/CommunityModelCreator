...
within ResidentialCommunityUK.Terrace_7.Terrace_7_Models;
model Terrace_7_House
  ...
  IBPSA.BoundaryConditions.SolarIrradiation.DiffusePerez HDifTil[2](
    ...
    azi = {2.8851211695570385, -0.2564714840327544})
  ...
  thermalZoneFourElements(
    ...
    nExt=1,
    RExt={0.002400172696196217},
    CExt={6642719.714410374},
    alphaRad=5.96374712587846,
    ...
    ARoof=40.89030532960141,
    alphaRoof=4.3,
    nRoof=1,
    RRoof={0.008469146363682794},
    RRoofRem=0.1272923206657431,
    CRoof={1060248.6452171465},
    ...
    nOrientations=2,
    AWin={3.1789833025450265, 6.658027115303721},
    ATransparent={3.1789833025450265, 6.658027115303721},
    AExt={24.041367354240332, 20.613173974569953})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  IBPSA.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=2,
    wfGro=0.0,
    wfWall={0.6297668744016026, 0.37023312559839744},
    wfWin={0.32316559274725637, 0.6768344072527437},
    withLongwave=true,
    aExt=0.9197166114277446,
  ...
  IBPSA.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=19.7*44.65454132881028)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://ResidentialCommunityUK/Terrace_7/Terrace_7_Models/InternalGains_Terrace_7House.mat"),
    columns={2,3,4})
  ...
  IBPSA.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007 eqAirTempVDI(
    ...
    alphaRad=5.7,
    n=4,
    wfWall={0.3741858288806478, 0.1258141711193522, 0.3741858288806478, 0.1258141711193522},
    wfWin={0, 0, 0, 0},
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant alphaRoof(k=973.1892668445134)
  ...
  IBPSA.BoundaryConditions.SolarIrradiation.DirectTiltedSurface HDirTilRoof[4](
    ...
    each lat = 0.886452727088,
    azi={2.8851211695570385, -1.827267810827651, -0.2564714840327544, 1.3143248427621421})
