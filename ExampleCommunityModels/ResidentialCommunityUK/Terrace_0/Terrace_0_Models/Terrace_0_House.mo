...
within ResidentialCommunityUK.Terrace_0.Terrace_0_Models;
model Terrace_0_House
  ...
  IBPSA.BoundaryConditions.SolarIrradiation.DiffusePerez HDifTil[2](
    ...
    azi = {0.9524057479159567, -2.1891869056738362})
  ...
  thermalZoneFourElements(
    ...
    nExt=1,
    RExt={0.00218637614277543},
    CExt={7285366.360996715},
    ...
    ARoof=44.856747129473,
    alphaRoof=4.3,
    nRoof=1,
    RRoof={0.007720265129624918},
    RRoofRem=0.1160365427995072,
    CRoof={1163094.8947315065},
    ...
    nOrientations=2,
    AWin={3.416707512343395, 6.873245836715727},
    ATransparent={3.416707512343395, 6.873245836715727},
    AExt={26.21434501072691, 22.612693279249026})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  IBPSA.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=2,
    wfGro=0.0,
    wfWall={0.6186114887865255, 0.38138851121347456},
    wfWin={0.3320430517457892, 0.6679569482542108},
    withLongwave=true,
    aExt=0.9205953746923401,
  ...
  IBPSA.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=19.700000000000003*48.82703828997593)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://ResidentialCommunityUK/Terrace_0/Terrace_0_Models/InternalGains_Terrace_0House.mat"),
    columns={2,3,4})
  ...
  IBPSA.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007 eqAirTempVDI(
    ...
    alphaRad=5.7,
    n=4,
    wfWall={0.1258141711193522, 0.37418582888064783, 0.37418582888064783, 0.1258141711193522},
    wfWin={0, 0, 0, 0},
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant alphaRoof(k=1067.5905816814575)
  ...
  IBPSA.BoundaryConditions.SolarIrradiation.DirectTiltedSurface HDirTilRoof[4](
    ...
    each lat = 0.886452727088,
    azi={2.5232020747108526, 0.9524057479159567, -2.1891869056738362, -0.61839057887894})
