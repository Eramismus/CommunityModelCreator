...
within ResidentialCommunityUK.SemiDetached_1.SemiDetached_1_Models;
model SemiDetached_1_House
  ...
  IBPSA.BoundaryConditions.SolarIrradiation.DiffusePerez HDifTil[3](
    ...
    azi = {-0.333906282865346, 2.8076863707244466, 1.2368900439295507})
  ...
  thermalZoneFourElements(
    ...
    ratioWinConRad=0.03,
    nExt=1,
    RExt={0.0011546450468345607},
    CExt={13706060.096692134},
    ...
    ARoof=52.10604570435151,
    alphaRoof=4.3,
    nRoof=1,
    RRoof={0.007106646021070778},
    RRoofRem=0.1021909618954313,
    CRoof={1396749.3004724267},
    ...
    nOrientations=3,
    AWin={5.9094279263019835, 3.6961902569867897, 0.6871343617160639},
    ATransparent={5.9094279263019835, 3.6961902569867897, 0.6871343617160639},
    AExt={25.830679223652115, 28.28161300837794, 37.91205385332259})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  IBPSA.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=3,
    wfGro=0.0,
    wfWall={0.31365841398754546, 0.3362885965078699, 0.3500529895045848},
    wfWin={0.574134848813584, 0.3591061031366758, 0.06675904804974023},
    withLongwave=true,
    aExt=0.920020032316794,
  ...
  IBPSA.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=19.700000000000006*92.02434608535263)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://ResidentialCommunityUK/SemiDetached_1/SemiDetached_1_Models/InternalGains_SemiDetached_1House.mat"),
    columns={2,3,4})
  ...
  IBPSA.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007 eqAirTempVDI(
    ...
    alphaRad=5.7,
    n=4,
    wfWall={0.2727272727272727, 0.2272727272727273, 0.2727272727272727, 0.2272727272727273},
    wfWin={0, 0, 0, 0},
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant alphaRoof(k=1240.123887763566)
  ...
  IBPSA.BoundaryConditions.SolarIrradiation.DirectTiltedSurface HDirTilRoof[4](
    ...
    each lat = 0.886452727088,
    azi={1.2368900439295507, -0.333906282865346, -1.9047026096602433, 2.8076863707244466})
