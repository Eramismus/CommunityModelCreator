...
within ResidentialCommunityUK.SemiDetached_4.SemiDetached_4_Models;
model SemiDetached_4_House
  ...
  IBPSA.BoundaryConditions.SolarIrradiation.DiffusePerez HDifTil[3](
    ...
    azi = {0.40270896600889095, -2.738883687580902, -1.1680873607860054})
  ...
  thermalZoneFourElements(
    ...
    nExt=1,
    RExt={0.001319550899459001},
    CExt={11945310.670339793},
    ...
    ARoof=62.066169104319776,
    alphaRoof=4.299999999999999,
    nRoof=1,
    RRoof={0.005893992405274548},
    RRoofRem=0.08543176282415056,
    CRoof={1653657.4140391368},
    ...
    nOrientations=3,
    AWin={3.5528103831121864, 5.8268247359166665, 0.6604795546666908},
    ATransparent={3.5528103831121864, 5.8268247359166665, 0.6604795546666908},
    AExt={24.845692891780587, 22.71085155583928, 33.022605588490066})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  IBPSA.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=3,
    wfGro=0.0,
    wfWall={0.33726148414090373, 0.31476578598903304, 0.34797272987006317},
    wfWin={0.3538615343129816, 0.5803544008498801, 0.06578406483713825},
    withLongwave=true,
    aExt=0.9186025107042153,
    alphaWallOut=14.0,
    alphaRad=5.7,
    alphaWinOut=5.7,
  ...
  IBPSA.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=19.7*80.57915003610994)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://ResidentialCommunityUK/SemiDetached_4/SemiDetached_4_Models/InternalGains_SemiDetached_4House.mat"),
    columns={2,3,4})
  ...
  IBPSA.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007 eqAirTempVDI(
    ...
    n=4,
    wfWall={0.27272727272727276, 0.22727272727272727, 0.27272727272727276, 0.22727272727272727},
    wfWin={0, 0, 0, 0},
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant alphaRoof(k=1477.1748246828108)
  ...
  IBPSA.BoundaryConditions.SolarIrradiation.DirectTiltedSurface HDirTilRoof[4](
    ...
    each lat = 0.886452727088,
    azi={-1.1680873607860054, 0.40270896600889095, 1.9735052928037873, -2.738883687580902})
