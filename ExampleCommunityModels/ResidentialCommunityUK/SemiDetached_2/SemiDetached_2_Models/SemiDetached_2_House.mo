...
within ResidentialCommunityUK.SemiDetached_2.SemiDetached_2_Models;
model SemiDetached_2_House
  ...
  IBPSA.BoundaryConditions.SolarIrradiation.DiffusePerez HDifTil[3](
    ...
    azi = {-1.3400872925614813, 1.801505361028312, 0.23070903423341538})
  ...
  thermalZoneFourElements(
    ...
    nExt=1,
    RExt={0.0013789019214828595},
    CExt={11429540.73427062},
    ...
    ARoof=61.402344274200914,
    alphaRoof=4.3,
    nRoof=1,
    RRoof={0.0060119006243865595},
    RRoofRem=0.0866255525563219,
    CRoof={1643379.2656962993},
    ...
    nOrientations=3,
    AWin={5.9902556033318275, 3.836488253759758, 0.7132162373122694},
    ATransparent={5.9902556033318275, 3.836488253759758, 0.7132162373122694},
    AExt={21.798345405809865, 23.840734101988563, 31.592510055348587})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  IBPSA.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=3,
    wfGro=0.0,
    wfWall={0.316311426265973, 0.3386194147265911, 0.3450691590074362},
    wfWin={0.568337598024904, 0.36399457107970684, 0.0676678308953891},
    withLongwave=true,
    aExt=0.9181084928434747,
    alphaWallOut=14.0,
  ...
  IBPSA.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=19.700000000000003*77.23158956314701)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://ResidentialCommunityUK/SemiDetached_2/SemiDetached_2_Models/InternalGains_SemiDetached_2House.mat"),
    columns={2,3,4})
  ...
  IBPSA.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007 eqAirTempVDI(
    ...
    alphaRad=5.7,
    n=4,
    wfWall={0.2727272727272727, 0.22727272727272732, 0.22727272727272732, 0.2727272727272727},
    wfWin={0, 0, 0, 0},
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant alphaRoof(k=1461.3757937259818)
  ...
  IBPSA.BoundaryConditions.SolarIrradiation.DirectTiltedSurface HDirTilRoof[4](
    ...
    each lat = 0.886452727088,
    azi={0.23070903423341538, 1.801505361028312, -1.3400872925614813, -2.9108836193563774})
