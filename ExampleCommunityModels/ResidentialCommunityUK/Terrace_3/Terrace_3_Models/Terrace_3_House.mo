...
within ResidentialCommunityUK.Terrace_3.Terrace_3_Models;
model Terrace_3_House
  ...
  IBPSA.BoundaryConditions.SolarIrradiation.DiffusePerez HDifTil[2](
    ...
    azi = {0.5962451029204581, -2.545347550669335})
  ...
  thermalZoneFourElements(
    ...
    nExt=1,
    RExt={0.0023814849828235007},
    CExt={6694025.630660551},
    ...
    ARoof=41.20699074305461,
    alphaRoof=4.3,
    nRoof=1,
    RRoof={0.008404058982405614},
    RRoofRem=0.12631404924935136,
    CRoof={1068460.0116490507},
    ...
    nOrientations=2,
    AWin={3.1717654421514117, 6.651492573926712},
    ATransparent={3.1717654421514117, 6.651492573926712},
    AExt={24.21486046526778, 20.772817965244528})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  IBPSA.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=2,
    wfGro=0.0,
    wfWall={0.6286584336445393, 0.3713415663554605},
    wfWin={0.32288324677617697, 0.6771167532238229},
    withLongwave=true,
    aExt=0.9197927606842556,
  ...
  IBPSA.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=19.700000000000006*44.987678430512304)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://ResidentialCommunityUK/Terrace_3/Terrace_3_Models/InternalGains_Terrace_3House.mat"),
    columns={2,3,4})
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant alphaRoof(k=980.7263796846997)
  ...
  IBPSA.BoundaryConditions.SolarIrradiation.DirectTiltedSurface HDirTilRoof[4](
    ...
    each lat = 0.886452727088,
    azi={-0.9745512238744387, 2.1670414297153546, -2.545347550669335, 0.5962451029204581})
