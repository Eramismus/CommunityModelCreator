...
within ResidentialCommunityUK.SemiDetached_6.SemiDetached_6_Models;
model SemiDetached_6_House
  ...
  IBPSA.BoundaryConditions.SolarIrradiation.DiffusePerez HDifTil[3](
    ...
    azi = {-0.3520251554340872, 2.7895674981557064, 1.2187711713608094})
  ...
  thermalZoneFourElements(
    ...
    ratioWinConRad=0.03,
    nExt=1,
    RExt={0.0011561532048204376},
    CExt={13627960.863489557},
    alphaRad=5.947138576610481,
    ...
    RExtRem=0.016424044076916198,
    AFloor=44.564221916481856,
    alphaFloor=2.9999999999999996,
    nFloor=1,
    RFloor={0.002389598433118523},
    RFloorRem=0.003647702510940217,
    CFloor={17163025.25957225},
    ARoof=53.5024213682306,
    alphaRoof=4.299999999999999,
    nRoof=1,
    RRoof={0.005834974386837168},
    RRoofRem=0.09408852943244154,
    CRoof={1318853.6932067273},
    ...
    nOrientations=3,
    AWin={5.765068072642962, 3.445615218496923, 0.6405516083501492},
    ATransparent={5.765068072642962, 3.445615218496923, 0.6405516083501492},
    AExt={25.686614336521536, 28.1229518589516, 37.68627285276568})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  IBPSA.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=3,
    wfGro=0.0,
    wfWall={0.3097163326281651, 0.3328252597088518, 0.35745840766298304},
    wfWin={0.5852127303290068, 0.3497648014337057, 0.06502246823728754},
    withLongwave=true,
    aExt=0.9199623850706939,
    alphaWallOut=14.0,
  ...
  IBPSA.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=19.699999999999996*91.49583904823882)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://ResidentialCommunityUK/SemiDetached_6/SemiDetached_6_Models/InternalGains_SemiDetached_6House.mat"),
    columns={2,3,4})
  ...
  IBPSA.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007 eqAirTempVDI(
    ...
    alphaRad=5.699999999999999,
    n=4,
    wfWall={0.27272727272727276, 0.27272727272727276, 0.22727272727272727, 0.22727272727272727},
    wfWin={0, 0, 0, 0},
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant alphaRoof(k=1273.3576285638883)
  ...
  IBPSA.BoundaryConditions.SolarIrradiation.DirectTiltedSurface HDirTilRoof[4](
    ...
    each lat = 0.886452727088,
    azi={-1.922821482228983, 1.2187711713608094, 2.7895674981557064, -0.3520251554340872})
