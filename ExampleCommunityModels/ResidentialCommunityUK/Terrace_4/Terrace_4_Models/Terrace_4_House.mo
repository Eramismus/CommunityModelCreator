...
within ResidentialCommunityUK.Terrace_4.Terrace_4_Models;
model Terrace_4_House
  ...
  IBPSA.BoundaryConditions.SolarIrradiation.DiffusePerez HDifTil[2](
    ...
    azi = {0.4445192761435662, -2.6970733774462268})
  ...
  thermalZoneFourElements(
    ...
    nExt=1,
    RExt={0.0021710422715491865},
    CExt={7340499.719730423},
    ...
    ARoof=45.19714188903156,
    alphaRoof=4.300000000000001,
    nRoof=1,
    RRoof={0.007662121236389831},
    RRoofRem=0.11516263286990984,
    CRoof={1171921.0230705317},
    ...
    nOrientations=2,
    AWin={3.0877617135851425, 6.575441526912157},
    ATransparent={3.0877617135851425, 6.575441526912157},
    AExt={26.400827062960683, 22.7842893664451})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  IBPSA.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=2,
    wfGro=0.0,
    wfWall={0.6194147006267395, 0.3805852993732603},
    wfWin={0.3195381114043749, 0.6804618885956252},
    withLongwave=true,
    aExt=0.9206638423707084,
  ...
  IBPSA.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=19.7*49.18511642940578)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://ResidentialCommunityUK/Terrace_4/Terrace_4_Models/InternalGains_Terrace_4House.mat"),
    columns={2,3,4})
  ...
  IBPSA.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007 eqAirTempVDI(
    ...
    alphaRad=5.7,
    n=4,
    wfWall={0.37418582888064783, 0.1258141711193522, 0.37418582888064783, 0.1258141711193522},
    wfWin={0, 0, 0, 0},
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant alphaRoof(k=1075.6919769589513)
  ...
  IBPSA.BoundaryConditions.SolarIrradiation.DirectTiltedSurface HDirTilRoof[4](
    ...
    each lat = 0.886452727088,
    azi={0.4445192761435662, -1.1262770506513304, -2.6970733774462268, 2.0153156029384625})
