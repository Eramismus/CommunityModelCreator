...
within ResidentialCommunityUK.SemiDetached_3.SemiDetached_3_Models;
model SemiDetached_3_House
  ...
  IBPSA.BoundaryConditions.SolarIrradiation.DiffusePerez HDifTil[3](
    ...
    azi = {1.328004223862864, -1.8135884297269291, -0.24279210293203254})
  ...
  thermalZoneFourElements(
    ...
    nExt=1,
    RExt={0.0012470682832468691},
    CExt={12675692.862750955},
    ...
    ARoof=56.2198257406411,
    alphaRoof=4.300000000000001,
    nRoof=1,
    RRoof={0.006547398093880304},
    RRoofRem=0.09451774502250675,
    CRoof={1502532.7220868885},
    ...
    nOrientations=3,
    AWin={3.552814950894916, 5.826827367481448, 0.6604804038330627},
    ATransparent={3.552814950894916, 5.826827367481448, 0.6604804038330627},
    AExt={26.272494113712064, 24.006392132335353, 35.052999346812506})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  IBPSA.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=3,
    wfGro=0.0,
    wfWall={0.33780011699212, 0.3153788752279807, 0.3468210077798994},
    wfWin={0.35386170559806507, 0.5803541977223161, 0.06578409667961883},
    withLongwave=true,
    aExt=0.9192373174034627,
    alphaWallOut=14.0,
    alphaRad=5.7,
  ...
  IBPSA.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=19.700000000000003*85.33188559285992)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://ResidentialCommunityUK/SemiDetached_3/SemiDetached_3_Models/InternalGains_SemiDetached_3House.mat"),
    columns={2,3,4})
  ...
  IBPSA.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007 eqAirTempVDI(
    ...
    n=4,
    wfWall={0.2727272727272727, 0.2272727272727273, 0.2272727272727273, 0.2727272727272727},
    wfWin={0, 0, 0, 0},
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant alphaRoof(k=1338.031852627258)
  ...
  IBPSA.BoundaryConditions.SolarIrradiation.DirectTiltedSurface HDirTilRoof[4](
    ...
    each lat = 0.886452727088,
    azi={-0.24279210293203254, -1.8135884297269291, 1.328004223862864, 2.8988005506577603})
