...
within ResidentialCommunityUK.SemiDetached_8.SemiDetached_8_Models;
model SemiDetached_8_House
  ...
  IBPSA.BoundaryConditions.SolarIrradiation.DiffusePerez HDifTil[3](
    ...
    azi = {-0.5415435772341476, 1.029252749560749, 2.600049076355646})
  ...
  thermalZoneFourElements(
    ...
    nExt=1,
    RExt={0.0011689014747365725},
    CExt={13488762.494823892},
    ...
    RExtRem=0.01684860102446794,
    AFloor=41.77981769078388,
    alphaFloor=3.0,
    nFloor=1,
    RFloor={0.0025488525501216274},
    RFloorRem=0.00389080262115902,
    CFloor={16090667.255699202},
    ARoof=56.421140092950154,
    alphaRoof=4.3,
    nRoof=1,
    RRoof={0.005570905492542934},
    RRoofRem=0.08941129418565859,
    CRoof={1395373.689094907},
    ...
    nOrientations=3,
    AWin={5.851096914586135, 0.6683118216298031, 3.5949412245488968},
    ATransparent={5.851096914586135, 0.6683118216298031, 3.5949412245488968},
    AExt={25.441445390086653, 37.30203980934978, 27.852943062083934})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  IBPSA.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=3,
    wfGro=0.0,
    wfWall={0.31067095235827524, 0.3556651016301431, 0.3336639460115818},
    wfWin={0.578494607887157, 0.06607560784650426, 0.35542978426633876},
    withLongwave=true,
    aExt=0.9198627350147965,
    alphaWallOut=14.0,
    alphaRad=5.7,
  ...
  IBPSA.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=19.7*90.59642826152037)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://ResidentialCommunityUK/SemiDetached_8/SemiDetached_8_Models/InternalGains_SemiDetached_8House.mat"),
    columns={2,3,4})
  ...
  IBPSA.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007 eqAirTempVDI(
    ...
    n=4,
    wfWall={0.22727272727272732, 0.2727272727272727, 0.2727272727272727, 0.22727272727272732},
    wfWin={0, 0, 0, 0},
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant alphaRoof(k=1342.8231342122135)
  ...
  IBPSA.BoundaryConditions.SolarIrradiation.DirectTiltedSurface HDirTilRoof[4](
    ...
    each lat = 0.886452727088,
    azi={2.600049076355646, -2.1123399040290436, 1.029252749560749, -0.5415435772341476})
