...
within ResidentialCommunityUK_rad_2elements_example.Detached_0.Detached_0_Models;
model Detached_0_House
  "This is the simulation model of House within building Detached_0 with traceable ID None"
  ...
  IBPSA.BoundaryConditions.SolarIrradiation.DiffusePerez HDifTil[8](
    each outSkyCon=true,
    each outGroCon=true,
    til={1.5707963267948966, 0.9599310885968813, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 0.9599310885968813, 0.9599310885968813, 0.9599310885968813},
    each lat = 0.886452727088,
    azi = {2.2834143217553753, 0.7126179949604782, -2.4289746586293144, 0.7126179949604782, -0.8581783318344184, -2.4289746586293144, -0.8581783318344184, 2.2834143217553753})
  ...
  thermalZoneThreeElements(
    ...
    VAir=229.7710275769436,
    alphaExt=3.5183897556796584,
    alphaWin=3.000000000000001,
    gWin=0.84,
    ratioWinConRad=0.030000000000000002,
    nExt=1,
    RExt={0.000665200542092684},
    CExt={22529245.04127027},
    alphaRad=5.975611988557149,
    AInt=120.67009132244385,
    alphaInt=2.9999999999999996,
    nInt=1,
    RInt={0.0008774764460600116},
    CInt={6462579.915295081},
    RWin=0.014636820749875011,
    RExtRem=0.009573190719125012,
    AFloor=50.48526683486474,
    alphaFloor=3.0,
    nFloor=1,
    RFloor={0.002109340041978932},
    RFloorRem=0.0032198903635503274,
    CFloor={19443398.149010774},
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    floorRC(thermCapExt(each der_T(fixed=true))),
    nOrientations=8,
    AWin={5.309323621555027, 0.0, 0.7128308674432545, 0.0, 7.642015033724599, 0.0, 0.0, 0.0},
    ATransparent={5.309323621555027, 0.0, 0.7128308674432545, 0.0, 7.642015033724599, 0.0, 0.0, 0.0},
    AExt={29.415738117772378, 27.708506283032253, 39.96597920297333, 39.96597920297333, 26.937598752363854, 27.708506283032253, 17.485950566962103, 17.485950566962103})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  IBPSA.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=8,
    wfGro=0.0,
    wfWall={0.18789243450481938, 0.058744270546709304, 0.24163205004573388, 0.24163205004573388, 0.13721167022221462, 0.058744270546709304, 0.03707162704403985, 0.03707162704403985},
    wfWin={0.3885580907588908, 0.0, 0.05216788815872416, 0.0, 0.559274021082385, 0.0, 0.0, 0.0},
    withLongwave=true,
    aExt=0.7923313094949834,
    alphaWallOut=15.634921537143537,
    alphaRad=5.7,
    alphaWinOut=5.7,
  ...
  IBPSA.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=21.33492153714354*226.67420897607155)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant alphaWin(k=11.4*13.66416952272288)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://ResidentialCommunityUK_rad_2elements_example/Detached_0/Detached_0_Models/InternalGains_Detached_0House.mat"),
    columns={2,3,4})
