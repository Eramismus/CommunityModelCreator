...
within ResidentialCommunityUK_rad_2elements_example.SemiDetached_7.SemiDetached_7_Models;
model SemiDetached_7_House
  "This is the simulation model of House within building SemiDetached_7 with traceable ID None"
  ...
  IBPSA.BoundaryConditions.SolarIrradiation.DiffusePerez HDifTil[7](
    each outSkyCon=true,
    each outGroCon=true,
    til={0.9599310885968813, 0.9599310885968813, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 0.9599310885968813, 0.9599310885968813},
    each lat = 0.886452727088,
    azi = {1.322408590342835, -0.24838773645206152, -0.24838773645206152, 2.893204917137732, 1.322408590342835, -1.819184063246958, 2.893204917137732})
  ...
  thermalZoneThreeElements(
    ...
    VAir=203.1104172646582,
    alphaExt=3.5206478467725626,
    alphaWin=2.9999999999999996,
    gWin=0.8400000000000001,
    ratioWinConRad=0.03,
    nExt=1,
    RExt={0.0010680649651782044},
    CExt={14077167.803595692},
    alphaRad=5.97947349441685,
    AInt=124.71997677304904,
    alphaInt=2.9999999999999996,
    nInt=1,
    RInt={0.0007695204271036659},
    CInt={7594676.025172315},
    RWin=0.018794714516017393,
    RExtRem=0.015421410071534442,
    AFloor=38.775769915861716,
    alphaFloor=3.0,
    nFloor=1,
    RFloor={0.0027463179995095306},
    RFloorRem=0.004192232018489255,
    CFloor={14933717.899810586},
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    floorRC(thermCapExt(each der_T(fixed=true))),
    nOrientations=7,
    AWin={0.0, 0.0, 6.023386582059734, 3.8939959060573335, 0.7239071058033024, 0.0, 0.0},
    ATransparent={0.0, 0.0, 6.023386582059734, 3.8939959060573335, 0.7239071058033024, 0.0, 0.0},
    AExt={15.498789050465637, 12.915657542054696, 23.934066916030826, 26.192841103322493, 34.93965000799736, 15.498789050465637, 12.915657542054696})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  IBPSA.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=7,
    wfGro=0.0,
    wfWall={0.05226979454351491, 0.043558162119595754, 0.254491319205414, 0.2726692374004605, 0.28118353006790425, 0.05226979454351491, 0.043558162119595754},
    wfWin={0.0, 0.0, 0.5660391561471123, 0.3659327069044403, 0.06802813694844732, 0.0, 0.0},
    withLongwave=true,
    aExt=0.7913631756128803,
    alphaWallOut=15.642043209051932,
  ...
  IBPSA.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=21.342043209051933*141.89545121239135)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant alphaWin(k=11.399999999999999*10.64128959392037)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://ResidentialCommunityUK_rad_2elements_example/SemiDetached_7/SemiDetached_7_Models/InternalGains_SemiDetached_7House.mat"),
    columns={2,3,4})
