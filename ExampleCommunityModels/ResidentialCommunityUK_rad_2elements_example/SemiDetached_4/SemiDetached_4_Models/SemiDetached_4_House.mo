...
within ResidentialCommunityUK_rad_2elements_example.SemiDetached_4.SemiDetached_4_Models;
model SemiDetached_4_House
  "This is the simulation model of House within building SemiDetached_4 with traceable ID None"
  ...
  IBPSA.BoundaryConditions.SolarIrradiation.DiffusePerez HDifTil[7](
    each outSkyCon=true,
    each outGroCon=true,
    til={0.9599310885968813, 1.5707963267948966, 0.9599310885968813, 0.9599310885968813, 0.9599310885968813, 1.5707963267948966, 1.5707963267948966},
    each lat = 0.886452727088,
    azi = {-2.738883687580902, -1.1680873607860054, -1.1680873607860054, 1.9735052928037873, 0.40270896600889095, 0.40270896600889095, -2.738883687580902})
  ...
  thermalZoneThreeElements(
    ...
    VAir=218.24185731683028,
    alphaExt=3.565640851882303,
    alphaWin=3.0,
    gWin=0.84,
    ratioWinConRad=0.030000000000000002,
    nExt=1,
    RExt={0.0011046823518188445},
    CExt={13588108.880814712},
    alphaRad=5.956193035871995,
    AInt=129.09391888367333,
    alphaInt=2.9999999999999996,
    nInt=1,
    RInt={0.0007608032665165575},
    CInt={7631659.578048446},
    RWin=0.01992009120413606,
    RExtRem=0.015154773957108032,
    AFloor=43.494718504158804,
    alphaFloor=2.9999999999999996,
    nFloor=1,
    RFloor={0.002448356916129689},
    RFloorRem=0.0037373968558344576,
    CFloor={16751127.255040718},
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    floorRC(thermCapExt(each der_T(fixed=true))),
    nOrientations=7,
    AWin={0.0, 0.6604795546666908, 0.0, 0.0, 0.0, 3.5528103831121864, 5.8268247359166665},
    ATransparent={0.0, 0.6604795546666908, 0.0, 0.0, 0.0, 3.5528103831121864, 5.8268247359166665},
    AExt={14.10594752370904, 33.022605588490066, 16.927137028450847, 16.927137028450847, 14.10594752370904, 24.845692891780587, 22.71085155583928})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  IBPSA.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=7,
    wfGro=0.0,
    wfWall={0.045613588677961794, 0.27813467599572467, 0.05473630641355417, 0.05473630641355417, 0.045613588677961794, 0.2695731750370064, 0.25159235878423697},
    wfWin={0.0, 0.06578406483713825, 0.0, 0.0, 0.0, 0.3538615343129816, 0.5803544008498801},
    withLongwave=true,
    aExt=0.7799758987299283,
    alphaWallOut=15.783944225167268,
    alphaRad=5.7,
    alphaWinOut=5.7,
  ...
  IBPSA.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=21.483944225167267*142.6453191404297)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant alphaWin(k=11.4*10.040114673695543)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://ResidentialCommunityUK_rad_2elements_example/SemiDetached_4/SemiDetached_4_Models/InternalGains_SemiDetached_4House.mat"),
    columns={2,3,4})
