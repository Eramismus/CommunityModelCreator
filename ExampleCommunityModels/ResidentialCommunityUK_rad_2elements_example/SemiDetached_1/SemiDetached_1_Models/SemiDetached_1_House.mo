...
within ResidentialCommunityUK_rad_2elements_example.SemiDetached_1.SemiDetached_1_Models;
model SemiDetached_1_House
  "This is the simulation model of House within building SemiDetached_1 with traceable ID None"
  ...
  IBPSA.BoundaryConditions.SolarIrradiation.DiffusePerez HDifTil[7](
    each outSkyCon=true,
    each outGroCon=true,
    til={0.9599310885968813, 1.5707963267948966, 0.9599310885968813, 0.9599310885968813, 1.5707963267948966, 1.5707963267948966, 0.9599310885968813},
    each lat = 0.886452727088,
    azi = {2.8076863707244466, -0.333906282865346, 1.2368900439295507, -1.9047026096602433, 2.8076863707244466, 1.2368900439295507, -0.333906282865346})
  ...
  thermalZoneThreeElements(
    ...
    VAir=181.63186598032186,
    alphaExt=3.4699762386998234,
    alphaWin=2.9999999999999996,
    gWin=0.8399999999999999,
    ratioWinConRad=0.03,
    nExt=1,
    RExt={0.0010113161327015604},
    CExt={15093694.234805498},
    alphaRad=5.961299998429243,
    AInt=130.85676145287837,
    alphaInt=3.0,
    nInt=1,
    RInt={0.0007382760084204647},
    CInt={7901588.158395095},
    RWin=0.01943114819145844,
    RExtRem=0.01548133980586448,
    AFloor=41.661719306503606,
    alphaFloor=3.0,
    nFloor=1,
    RFloor={0.002556077776851313},
    RFloorRem=0.003901831870809804,
    CFloor={16045184.007807784},
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    floorRC(thermCapExt(each der_T(fixed=true))),
    nOrientations=7,
    AWin={0.0, 5.9094279263019835, 0.0, 0.0, 3.6961902569867897, 0.6871343617160639, 0.0},
    ATransparent={0.0, 5.9094279263019835, 0.0, 0.0, 3.6961902569867897, 0.6871343617160639, 0.0},
    AExt={11.842283114625344, 25.830679223652115, 14.21073973755041, 14.21073973755041, 28.28161300837794, 37.91205385332259, 11.842283114625344})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  IBPSA.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=7,
    wfGro=0.0,
    wfWall={0.03855844953750724, 0.2604440126254308, 0.04627013944500868, 0.04627013944500868, 0.27923482224252344, 0.290663987167014, 0.03855844953750724},
    wfWin={0.0, 0.574134848813584, 0.0, 0.0, 0.3591061031366758, 0.06675904804974023, 0.0},
    withLongwave=true,
    aExt=0.8043263314730691,
    alphaWallOut=15.48223275282252,
    alphaRad=5.7,
    alphaWinOut=5.7,
  ...
  IBPSA.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=21.18223275282252*144.13039178970413)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant alphaWin(k=11.4*10.292752545004838)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://ResidentialCommunityUK_rad_2elements_example/SemiDetached_1/SemiDetached_1_Models/InternalGains_SemiDetached_1House.mat"),
    columns={2,3,4})
