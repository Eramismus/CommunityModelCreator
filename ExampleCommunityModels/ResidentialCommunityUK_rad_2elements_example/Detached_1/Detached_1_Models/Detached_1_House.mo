...
within ResidentialCommunityUK_rad_2elements_example.Detached_1.Detached_1_Models;
model Detached_1_House
  "This is the simulation model of House within building Detached_1 with traceable ID None"
  ...
  IBPSA.BoundaryConditions.SolarIrradiation.DiffusePerez HDifTil[8](
    each outSkyCon=true,
    each outGroCon=true,
    til={1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 0.9599310885968813, 1.5707963267948966, 0.9599310885968813, 0.9599310885968813, 0.9599310885968813},
    each lat = 0.886452727088,
    azi = {1.5414617714135619, 3.1122580982084584, -1.6001308821762315, 3.1122580982084584, -0.029334555381334417, -1.6001308821762315, -0.029334555381334417, 1.5414617714135619})
    "Calculates diffuse solar radiation on titled surface for all directions"
    annotation (Placement(transformation(extent={{-68,20},{-48,40}})));
  IBPSA.BoundaryConditions.SolarIrradiation.DirectTiltedSurface HDirTil[8](
    til={1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 0.9599310885968813, 1.5707963267948966, 0.9599310885968813, 0.9599310885968813, 0.9599310885968813},
    each lat =  0.886452727088,
    azi={1.5414617714135619, 3.1122580982084584, -1.6001308821762315, 3.1122580982084584, -0.029334555381334417, -1.6001308821762315, -0.029334555381334417, 1.5414617714135619})
    "Calculates direct solar radiation on titled surface for all directions"
    annotation (Placement(transformation(extent={{-68,52},{-48,72}})));
  IBPSA.ThermalZones.ReducedOrder.SolarGain.CorrectionGDoublePane corGDoublePane(n=8,
  ...
  thermalZoneThreeElements(
    ...
    VAir=272.52846404870047,
    alphaExt=3.4906011185970396,
    alphaWin=3.0,
    gWin=0.8400000000000001,
    ratioWinConRad=0.030000000000000002,
    nExt=1,
    RExt={0.0006857476670444136},
    CExt={21895854.290707823},
    alphaRad=5.979960251059889,
    AInt=120.0130072381055,
    alphaInt=3.000000000000001,
    nInt=1,
    RInt={0.0008865320271757098},
    CInt={6386061.28081043},
    RWin=0.014856987038768017,
    RExtRem=0.009539376378598781,
    AFloor=50.81567504918756,
    alphaFloor=3.0,
    nFloor=1,
    RFloor={0.002095624918131905},
    RFloorRem=0.0031989543389023003,
    CFloor={19570648.312584154},
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    floorRC(thermCapExt(each der_T(fixed=true))),
    nOrientations=8,
    AWin={0.0, 5.20055532387201, 0.6982276137118493, 0.0, 7.562896707024932, 0.0, 0.0, 0.0},
    ATransparent={0.0, 5.20055532387201, 0.6982276137118493, 0.0, 7.562896707024932, 0.0, 0.0, 0.0},
    AExt={39.22431017367886, 28.878233136656398, 39.22431017367886, 15.682367075234191, 26.416313109213487, 24.850520134601872, 15.682367075234191, 24.850520134601872})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  IBPSA.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=8,
    wfGro=0.0,
    wfWall={0.24709609329565332, 0.19187757380554052, 0.24709609329565332, 0.033456144281496576, 0.14098770916341674, 0.0530151209383715, 0.033456144281496576, 0.0530151209383715},
    wfWin={0.0, 0.3863229152058122, 0.05186779303513432, 0.0, 0.5618092917590536, 0.0, 0.0, 0.0},
    withLongwave=true,
    aExt=0.7990496520961736,
    alphaWallOut=15.547280450959892,
    alphaRad=5.7,
    alphaWinOut=5.700000000000002,
    TGro=286.15) "Computes equivalent air temperature"
    annotation (Placement(transformation(extent={{-24,-14},{-4,6}})));
  Modelica.Blocks.Math.Add solRad[8]
  ...
  Modelica.Blocks.Sources.Constant const[8](each k=0)
  ...
  IBPSA.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=21.247280450959895*214.80894101289968)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant alphaWin(k=11.400000000000004*13.46167964460879)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://ResidentialCommunityUK_rad_2elements_example/Detached_1/Detached_1_Models/InternalGains_Detached_1House.mat"),
    columns={2,3,4})
