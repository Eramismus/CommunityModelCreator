...
within ResidentialCommunityUK_rad_2elements_example.Detached_7.Detached_7_Models;
model Detached_7_House
  ...
  IBPSA.BoundaryConditions.SolarIrradiation.DiffusePerez HDifTil[8](
    each outSkyCon=true,
    each outGroCon=true,
    til={0.9599310885968813, 1.5707963267948966, 0.9599310885968813, 0.9599310885968813, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 0.9599310885968813},
    each lat = 0.886452727088,
    azi = {-0.6909485658604632, 0.8798477609344333, -2.2617448926553596, 0.8798477609344333, -2.2617448926553596, 2.45064408772933, -0.6909485658604632, 2.45064408772933})
  ...
  thermalZoneThreeElements(
    ...
    alphaExt=3.48100171421059,
    alphaWin=3.0,
    gWin=0.8399999999999999,
    ratioWinConRad=0.029999999999999992,
    nExt=1,
    RExt={0.0006448665604034651},
    CExt={23359049.39008901},
    ...
    nOrientations=8,
    AWin={0.0, 0.0, 0.0, 0.0, 0.6105940848104051, 4.547841214134469, 7.0881108615555535, 0.0},
    ATransparent={0.0, 0.0, 0.0, 0.0, 0.6105940848104051, 4.547841214134469, 7.0881108615555535, 0.0},
    AExt={16.25480352370041, 41.94498618584949, 25.757611737556037, 25.757611737556037, 41.94498618584949, 30.84997100190823, 28.32855332525337, 16.25480352370041})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  IBPSA.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=8,
    wfGro=0.0,
    wfWall={0.03573486449509375, 0.24375645025876078, 0.05662601604607165, 0.05662601604607165, 0.24375645025876078, 0.18967121936352524, 0.1380941190366226, 0.03573486449509375},
    wfWin={0.0, 0.0, 0.0, 0.0, 0.04985847248751599, 0.37135704667516084, 0.5787844808373233, 0.0},
    withLongwave=true,
    aExt=0.8018333364147836,
    alphaWallOut=15.517005406356475,
    alphaRad=5.7,
  ...
  IBPSA.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=21.217005406356474*227.09332722137344)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://ResidentialCommunityUK_rad_2elements_example/Detached_7/Detached_7_Models/InternalGains_Detached_7House.mat"),
    columns={2,3,4})
