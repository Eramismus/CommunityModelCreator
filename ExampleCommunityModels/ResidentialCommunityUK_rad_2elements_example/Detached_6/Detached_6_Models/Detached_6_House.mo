...
within ResidentialCommunityUK_rad_2elements_example.Detached_6.Detached_6_Models;
model Detached_6_House
  "This is the simulation model of House within building Detached_6 with traceable ID None"
  ...
  IBPSA.BoundaryConditions.SolarIrradiation.DiffusePerez HDifTil[8](
    each outSkyCon=true,
    each outGroCon=true,
    til={1.5707963267948966, 0.9599310885968813, 0.9599310885968813, 0.9599310885968813, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 0.9599310885968813},
    each lat = 0.886452727088,
    azi = {1.536785326018509, -1.6048073275712842, 1.536785326018509, 3.1075816528134057, -0.03401100077638778, 3.1075816528134057, -1.6048073275712842, -0.03401100077638778})
  ...
  thermalZoneThreeElements(
    ...
    VAir=261.8729030530708,
    alphaExt=3.539333472360474,
    alphaWin=3.0,
    gWin=0.84,
    ratioWinConRad=0.030000000000000002,
    nExt=1,
    RExt={0.0007498984764885864},
    CExt={20012397.90613272},
    alphaRad=5.955366628583988,
    AInt=131.4797258560739,
    alphaInt=3.0,
    nInt=1,
    RInt={0.0007697590031212638},
    CInt={7475497.405552553},
    RWin=0.01632249643788741,
    RExtRem=0.01101824212479943,
    AFloor=48.65129828397496,
    alphaFloor=3.000000000000001,
    nFloor=1,
    RFloor={0.0021888541235465376},
    RFloorRem=0.0033412679602918605,
    CFloor={18737081.574625775},
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    floorRC(thermCapExt(each der_T(fixed=true))),
    nOrientations=8,
    AWin={0.0, 0.0, 0.0, 0.0, 7.090643352474341, 4.5513227681261235, 0.6110615189562245, 0.0},
    ATransparent={0.0, 0.0, 0.0, 0.0, 7.090643352474341, 4.5513227681261235, 0.6110615189562245, 0.0},
    AExt={35.34857990955646, 26.18180232421717, 26.18180232421717, 16.52249661237006, 23.69223745874132, 26.069400301328947, 35.34857990955646, 16.52249661237006})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  IBPSA.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=8,
    wfGro=0.0,
    wfWall={0.2381987519754445, 0.06331078457575536, 0.06331078457575536, 0.039953407741981535, 0.12965560568999085, 0.1874185057236467, 0.2381987519754445, 0.039953407741981535},
    wfWin={0.0, 0.0, 0.0, 0.0, 0.5786850043154623, 0.37144474835207253, 0.049870247332465215, 0.0},
    withLongwave=true,
    aExt=0.7864005862453874,
    alphaWallOut=15.70097479744457,
    alphaRad=5.7,
    alphaWinOut=5.7,
  ...
  IBPSA.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=21.40097479744457*205.86739545235764)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant alphaWin(k=11.4*12.253027639556688)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://ResidentialCommunityUK_rad_2elements_example/Detached_6/Detached_6_Models/InternalGains_Detached_6House.mat"),
    columns={2,3,4})
