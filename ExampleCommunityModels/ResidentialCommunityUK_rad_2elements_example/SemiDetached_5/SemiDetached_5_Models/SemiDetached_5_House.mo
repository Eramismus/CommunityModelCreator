...
within ResidentialCommunityUK_rad_2elements_example.SemiDetached_5.SemiDetached_5_Models;
model SemiDetached_5_House
  "This is the simulation model of House within building SemiDetached_5 with traceable ID None"
  ...
  IBPSA.BoundaryConditions.SolarIrradiation.DiffusePerez HDifTil[7](
    each outSkyCon=true,
    each outGroCon=true,
    til={1.5707963267948966, 1.5707963267948966, 0.9599310885968813, 1.5707963267948966, 0.9599310885968813, 0.9599310885968813, 0.9599310885968813},
    each lat = 0.886452727088,
    azi = {-1.2705072271233229, 0.3002890996715735, 0.3002890996715735, 1.87108542646647, 1.87108542646647, -1.2705072271233229, -2.8413035539182196})
  ...
  thermalZoneThreeElements(
    ...
    VAir=197.1412369612199,
    alphaExt=3.490133762324031,
    alphaWin=2.9999999999999987,
    gWin=0.8399999999999997,
    ratioWinConRad=0.02999999999999999,
    nExt=1,
    RExt={0.001052180308730839},
    CExt={14297738.836857516},
    alphaRad=5.950026875287295,
    AInt=133.6908392948766,
    alphaInt=3.0,
    nInt=1,
    RInt={0.0007320598117112898},
    CInt={7939380.025627992},
    RWin=0.020223330264001086,
    RExtRem=0.014900989179620138,
    AFloor=44.51682249776061,
    alphaFloor=3.0,
    nFloor=1,
    RFloor={0.0023921427651339695},
    RFloorRem=0.0036515864130020792,
    CFloor={17144770.31455545},
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    floorRC(thermCapExt(each der_T(fixed=true))),
    nOrientations=7,
    AWin={5.7776015739270985, 0.6445959806900478, 0.0, 3.4673704536754206, 0.0, 0.0, 0.0},
    ATransparent={5.7776015739270985, 0.6445959806900478, 0.0, 3.4673704536754206, 0.0, 0.0, 0.0},
    AExt={24.55423504501297, 35.911588302358965, 14.416218898933735, 26.87584297936397, 12.013515749111447, 12.013515749111447, 14.416218898933735})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  IBPSA.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=7,
    wfGro=0.0,
    wfWall={0.2578810591302896, 0.29030920483973477, 0.04777112814729807, 0.27664893282321623, 0.039809273456081734, 0.039809273456081734, 0.04777112814729807},
    wfWin={0.5842117238167011, 0.06517938702171251, 0.0, 0.3506088891615865, 0.0, 0.0, 0.0},
    withLongwave=true,
    aExt=0.7990308406837165,
    alphaWallOut=15.545806481175791,
    alphaRad=5.7,
    alphaWinOut=5.7,
  ...
  IBPSA.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=21.245806481175787*140.20113562282626)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant alphaWin(k=11.4*9.889568008292569)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://ResidentialCommunityUK_rad_2elements_example/SemiDetached_5/SemiDetached_5_Models/InternalGains_SemiDetached_5House.mat"),
    columns={2,3,4})
