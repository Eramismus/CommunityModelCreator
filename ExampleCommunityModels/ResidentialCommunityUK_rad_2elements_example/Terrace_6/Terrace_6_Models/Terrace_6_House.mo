...
within ResidentialCommunityUK_rad_2elements_example.Terrace_6.Terrace_6_Models;
model Terrace_6_House
  ...
  IBPSA.BoundaryConditions.SolarIrradiation.DiffusePerez HDifTil[6](
    each outSkyCon=true,
    each outGroCon=true,
    til={0.9599310885968813, 1.5707963267948966, 0.9599310885968813, 0.9599310885968813, 0.9599310885968813, 1.5707963267948966},
    each lat = 0.886452727088,
    azi = {1.5683195674375014, 1.5683195674375014, -1.573273086152292, -0.002476759357395301, 3.139115894232398, -1.573273086152292})
  ...
  thermalZoneThreeElements(
    ...
    alphaExt=3.620631382723456,
    alphaWin=3.0,
    gWin=0.84,
    ratioWinConRad=0.029999999999999995,
    nExt=1,
    RExt={0.002069307752183205},
    CExt={7229157.02336273},
    alphaRad=5.97014718844004,
    ...
    nOrientations=6,
    AWin={0.0, 3.1692295099142362, 0.0, 0.0, 0.0, 6.649196719860628},
    ATransparent={0.0, 3.1692295099142362, 0.0, 0.0, 0.0, 6.649196719860628},
    AExt={14.374410822054195, 22.685385795895897, 14.374410822054195, 4.833172299217789, 4.833172299217789, 19.365433900204735})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  IBPSA.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=6,
    wfGro=0.0,
    wfWall={0.10948104748696733, 0.450391496949318, 0.10948104748696733, 0.036811301176359466, 0.036811301176359466, 0.25702380572402844},
    wfWin={0.0, 0.32278385922006425, 0.0, 0.0, 0.0, 0.6772161407799357},
    withLongwave=true,
    aExt=0.7667483514083098,
    alphaWallOut=15.957375899358594,
  ...
  IBPSA.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=21.65737589935859*80.4659859386446)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://ResidentialCommunityUK_rad_2elements_example/Terrace_6/Terrace_6_Models/InternalGains_Terrace_6House.mat"),
    columns={2,3,4})
