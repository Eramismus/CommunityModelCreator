...
within ResidentialCommunityUK_rad_2elements_example.Terrace_1.Terrace_1_Models;
model Terrace_1_House
  "This is the simulation model of House within building Terrace_1 with traceable ID None"
  ...
  IBPSA.BoundaryConditions.SolarIrradiation.DiffusePerez HDifTil[6](
    each outSkyCon=true,
    each outGroCon=true,
    til={0.9599310885968813, 0.9599310885968813, 0.9599310885968813, 0.9599310885968813, 1.5707963267948966, 1.5707963267948966},
    each lat = 0.886452727088,
    azi = {0.12278207796556499, -1.4480142488293315, 1.693578404760462, -3.018810575624228, -3.018810575624228, 0.12278207796556499})
  ...
  thermalZoneThreeElements(
    ...
    VAir=180.26243611405067,
    alphaExt=3.6217592309860396,
    alphaWin=3.0,
    gWin=0.8400000000000002,
    ratioWinConRad=0.03,
    nExt=1,
    RExt={0.001886663549648761},
    CExt={7933678.502051568},
    alphaRad=5.967596388239629,
    AInt=190.84002239113477,
    alphaInt=3.0,
    nInt=1,
    RInt={0.0004640502915594783},
    CInt={12856396.30811349},
    RWin=0.01886698801028585,
    RExtRem=0.033534437295913884,
    AFloor=39.18748611175015,
    alphaFloor=3.000000000000001,
    nFloor=1,
    RFloor={0.002717464308914691},
    RFloorRem=0.004148187095219311,
    CFloor={15092282.218134178},
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    floorRC(thermCapExt(each der_T(fixed=true))),
    nOrientations=6,
    AWin={0.0, 0.0, 0.0, 0.0, 7.020816488750059, 3.579709673187636},
    ATransparent={0.0, 0.0, 0.0, 0.0, 7.020816488750059, 3.579709673187636},
    AExt={15.77874114540306, 5.305356550926224, 5.305356550926224, 15.77874114540306, 21.257369951534262, 24.741447349000204})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  IBPSA.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=6,
    wfGro=0.0,
    wfWall={0.11209378486492284, 0.03768979352478261, 0.03768979352478261, 0.11209378486492284, 0.2591917134059159, 0.4412411298146732},
    wfWin={0.0, 0.0, 0.0, 0.0, 0.662308302578323, 0.3376916974216771},
    withLongwave=true,
    aExt=0.7669605134564446,
    alphaWallOut=15.960932959263667,
    alphaRad=5.7,
  ...
  IBPSA.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=21.66093295926367*88.16701269319304)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant alphaWin(k=11.400000000000002*10.600526161937694)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://ResidentialCommunityUK_rad_2elements_example/Terrace_1/Terrace_1_Models/InternalGains_Terrace_1House.mat"),
    columns={2,3,4})
