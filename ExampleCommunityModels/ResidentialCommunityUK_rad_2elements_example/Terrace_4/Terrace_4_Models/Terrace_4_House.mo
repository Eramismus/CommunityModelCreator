...
within ResidentialCommunityUK_rad_2elements_example.Terrace_4.Terrace_4_Models;
model Terrace_4_House
  "This is the simulation model of House within building Terrace_4 with traceable ID None"
  ...
  IBPSA.BoundaryConditions.SolarIrradiation.DiffusePerez HDifTil[6](
    ...
    azi = {2.0153156029384625, 0.4445192761435662, -2.6970733774462268, -1.1262770506513304, -2.6970733774462268, 0.4445192761435662})
  ...
  thermalZoneThreeElements(
    ...
    VAir=180.01262710351853,
    alphaExt=3.6225352677777907,
    alphaWin=3.0,
    gWin=0.8400000000000001,
    ratioWinConRad=0.029999999999999995,
    nExt=1,
    RExt={0.0017582426776247644},
    CExt={8502297.293319853},
    alphaRad=5.949426495147228,
    AInt=178.37736193377955,
    alphaInt=3.0,
    nInt=1,
    RInt={0.0004897783777968797},
    CInt={12219928.310462793},
    RWin=0.020697070632005807,
    RExtRem=0.03073260879170112,
    AFloor=39.133179805112725,
    alphaFloor=3.000000000000001,
    nFloor=1,
    RFloor={0.002721235416981327},
    RFloorRem=0.0041539436609138,
    CFloor={15071367.22237101},
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    floorRC(thermCapExt(each der_T(fixed=true))),
    nOrientations=6,
    AWin={0.0, 0.0, 6.575441526912157, 0.0, 0.0, 3.0877617135851425},
    ATransparent={0.0, 0.0, 6.575441526912157, 0.0, 0.0, 3.0877617135851425},
    AExt={5.686440943732258, 16.912130000783524, 22.7842893664451, 5.686440943732258, 16.912130000783524, 26.400827062960683})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  IBPSA.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=6,
    wfGro=0.0,
    wfWall={0.03684613322318793, 0.10958464200416808, 0.2691264985185366, 0.03684613322318793, 0.10958464200416808, 0.43801195102675133},
    wfWin={0.0, 0.0, 0.6804618885956252, 0.0, 0.0, 0.3195381114043749},
    withLongwave=true,
    aExt=0.7671064954653973,
    alphaWallOut=15.963380459914571,
  ...
  IBPSA.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=21.66338045991457*94.38225831843735)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant alphaWin(k=11.399999999999999*9.6632032404973)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://ResidentialCommunityUK_rad_2elements_example/Terrace_4/Terrace_4_Models/InternalGains_Terrace_4House.mat"),
    columns={2,3,4})
