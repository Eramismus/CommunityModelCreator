...
within ResidentialCommunityUK_rad_2elements_example.Detached_9.Detached_9_Models;
model Detached_9_House
  "This is the simulation model of House within building Detached_9 with traceable ID None"
  ...
  IBPSA.BoundaryConditions.SolarIrradiation.DiffusePerez HDifTil[8](
    each outSkyCon=true,
    each outGroCon=true,
    til={0.9599310885968813, 0.9599310885968813, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 0.9599310885968813, 1.5707963267948966, 0.9599310885968813},
    each lat = 0.886452727088,
    azi = {-2.826076241423578, 1.8863127389611118, -1.2552799146286815, 0.3155164121662153, 1.8863127389611118, -1.2552799146286815, -2.826076241423578, 0.3155164121662153})
  ...
  thermalZoneThreeElements(
    ...
    VAir=225.95797152264248,
    alphaExt=3.5369295371692275,
    alphaWin=3.0,
    gWin=0.84,
    ratioWinConRad=0.030000000000000002,
    nExt=1,
    RExt={0.0007608440008069891},
    CExt={19636468.64968465},
    alphaRad=5.9655249621688275,
    AInt=126.41567371688197,
    alphaInt=2.9999999999999996,
    nInt=1,
    RInt={0.0008483894662651889},
    CInt={6654679.571087453},
    RWin=0.01580451059819877,
    RExtRem=0.010482298995118804,
    AFloor=54.58236649928949,
    alphaFloor=2.9999999999999996,
    nFloor=1,
    RFloor={0.0019510072885197708},
    RFloorRem=0.002978196707263763,
    CFloor={21021314.737867493},
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    floorRC(thermCapExt(each der_T(fixed=true))),
    nOrientations=8,
    AWin={0.0, 0.0, 7.247554581216689, 0.0, 4.767037229611666, 0.0, 0.6400233863542715, 0.0},
    ATransparent={0.0, 0.0, 7.247554581216689, 0.0, 4.767037229611666, 0.0, 0.6400233863542715, 0.0},
    AExt={25.56479127422399, 16.133120707034553, 23.294670591994077, 34.78293411436809, 25.659463496026074, 16.133120707034553, 34.78293411436809, 25.56479127422399})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  IBPSA.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=8,
    wfGro=0.0,
    wfWall={0.05968759226530914, 0.03766692715771936, 0.13352117812975126, 0.2413546664845861, 0.18906045005501965, 0.03766692715771936, 0.2413546664845861, 0.05968759226530914},
    wfWin={0.0, 0.0, 0.5727202659493159, 0.0, 0.37670345208702827, 0.0, 0.050576281963655725, 0.0},
    withLongwave=true,
    aExt=0.7868798571159995,
    alphaWallOut=15.693393155687561,
    alphaRad=5.699999999999998,
    alphaWinOut=5.7,
  ...
  IBPSA.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=21.393393155687566*201.9158262792734)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant alphaWin(k=11.4*12.654615197182626)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://ResidentialCommunityUK_rad_2elements_example/Detached_9/Detached_9_Models/InternalGains_Detached_9House.mat"),
    columns={2,3,4})
