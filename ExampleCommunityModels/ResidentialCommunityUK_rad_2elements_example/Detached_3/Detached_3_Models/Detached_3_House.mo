...
within ResidentialCommunityUK_rad_2elements_example.Detached_3.Detached_3_Models;
model Detached_3_House
  "This is the simulation model of House within building Detached_3 with traceable ID None"
  ...
  IBPSA.BoundaryConditions.SolarIrradiation.DiffusePerez HDifTil[8](
    each outSkyCon=true,
    each outGroCon=true,
    til={1.5707963267948966, 0.9599310885968813, 1.5707963267948966, 0.9599310885968813, 1.5707963267948966, 1.5707963267948966, 0.9599310885968813, 0.9599310885968813},
    each lat = 0.886452727088,
    azi = {1.8041637116322216, 0.2333673848373249, -2.908225268752468, -1.3374289419575716, 0.2333673848373249, -1.3374289419575716, -2.908225268752468, 1.8041637116322216})
  ...
  thermalZoneThreeElements(
    ...
    VAir=254.64310587348848,
    alphaExt=3.486772379301817,
    alphaWin=2.9999999999999996,
    gWin=0.84,
    ratioWinConRad=0.03,
    nExt=1,
    RExt={0.0006876847383066967},
    CExt={21919303.843343403},
    alphaRad=5.975724283641367,
    AInt=133.0211492908469,
    alphaInt=2.9999999999999996,
    nInt=1,
    RInt={0.0007803093005382596},
    CInt={7315630.217066069},
    RWin=0.014542190023632419,
    RExtRem=0.010373747115343718,
    AFloor=52.84667494534677,
    alphaFloor=3.0,
    nFloor=1,
    RFloor={0.002015086000678418},
    RFloorRem=0.0030760123385428118,
    CFloor={20352847.59759124},
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    floorRC(thermCapExt(each der_T(fixed=true))),
    nOrientations=8,
    AWin={0.7192434343784909, 0.0, 7.676757398343959, 0.0, 5.357085853325614, 0.0, 0.0, 0.0},
    ATransparent={0.7192434343784909, 0.0, 7.676757398343959, 0.0, 5.357085853325614, 0.0, 0.0, 0.0},
    AExt={39.330942854013145, 15.529043407930548, 26.49126040127149, 24.607561092566865, 28.955512346877637, 39.330942854013145, 15.529043407930548, 24.607561092566865})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  IBPSA.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=8,
    wfGro=0.0,
    wfWall={0.24383757324902822, 0.03592980897191765, 0.13603758591553844, 0.05693492806319258, 0.19055779351618468, 0.24383757324902822, 0.03592980897191765, 0.05693492806319258},
    wfWin={0.05229687347991005, 0.0, 0.5581843242602194, 0.0, 0.3895188022598705, 0.0, 0.0, 0.0},
    withLongwave=true,
    aExt=0.8000087871195742,
    alphaWallOut=15.535205196259579,
    alphaRad=5.700000000000002,
  ...
  IBPSA.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=21.23520519625958*214.3818674571702)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant alphaWin(k=11.400000000000002*13.753086686048064)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://ResidentialCommunityUK_rad_2elements_example/Detached_3/Detached_3_Models/InternalGains_Detached_3House.mat"),
    columns={2,3,4})
