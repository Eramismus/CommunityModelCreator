...
within ResidentialCommunityUK_rad_2elements_example.SemiDetached_11.SemiDetached_11_Models;
model SemiDetached_11_House_mpc
...
parameter Real COP_nominal = 2.5 "Nominal COP";
  ...
  HDifTil[7](
    ...
    azi = {-1.5632418829259977, -1.5632418829259977, -3.1340382097208943, 0.007554443868899053, 0.007554443868899053, 1.5783507706637954, 1.5783507706637954})
  ...
  thermalZoneTwoElements(
    ...
    alphaExt=3.4948414873988747,
    alphaWin=2.9999999999999996,
    gWin=0.84,
    ratioWinConRad=0.03,
    nExt=1,
    RExt={0.0010444028523600626},
    CExt={14510097.919658707},
    ...
    RExtRem=0.015499306254421608,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    nOrientations=7,
    AWin={5.832669030554417, 0.0, 0.0, 0.6623654206384806, 0.0, 0.0, 3.56295471560271},
    ATransparent={5.832669030554417, 0.0, 0.0, 0.6623654206384806, 0.0, 0.0, 3.56295471560271},
    AExt={24.759368163213235, 12.304936458604628, 14.765923750325554, 36.233076498387156, 14.765923750325554, 12.304936458604628, 27.101759626836603})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  IBPSA.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=7,
    wfGro=0.0,
    wfWall={0.25778415733520293, 0.040895518907940014, 0.04907462268952804, 0.28600198129835536, 0.04907462268952804, 0.040895518907940014, 0.2762735781715059},
    wfWin={0.5799040875694895, 0.0, 0.0, 0.06585465639843245, 0.0, 0.0, 0.3542412560320781},
    withLongwave=true,
    aExt=0.7979295137520048,
    alphaWallOut=15.560653921796451,
    alphaRad=5.7,
  ...
  IBPSA.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=21.26065392179645*142.23592470629737)
