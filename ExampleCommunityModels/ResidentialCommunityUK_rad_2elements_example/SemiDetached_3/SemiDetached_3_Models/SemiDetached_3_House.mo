...
within ResidentialCommunityUK_rad_2elements_example.SemiDetached_3.SemiDetached_3_Models;
model SemiDetached_3_House
  "This is the simulation model of House within building SemiDetached_3 with traceable ID None"
  ...
  IBPSA.BoundaryConditions.SolarIrradiation.DiffusePerez HDifTil[7](
    each outSkyCon=true,
    each outGroCon=true,
    til={1.5707963267948966, 0.9599310885968813, 0.9599310885968813, 1.5707963267948966, 0.9599310885968813, 0.9599310885968813, 1.5707963267948966},
    each lat = 0.886452727088,
    azi = {1.328004223862864, -0.24279210293203254, 2.8988005506577603, -1.8135884297269291, -1.8135884297269291, 1.328004223862864, -0.24279210293203254})
  ...
  thermalZoneThreeElements(
    ...
    VAir=205.49394116577437,
    alphaExt=3.516318543762715,
    alphaWin=2.9999999999999996,
    gWin=0.8399999999999999,
    ratioWinConRad=0.029999999999999995,
    nExt=1,
    RExt={0.0010697742447253588},
    CExt={14168334.993369391},
    alphaRad=5.961107472576772,
    AInt=126.09291396280159,
    alphaInt=3.0,
    nInt=1,
    RInt={0.000773326112934338},
    CInt={7523634.553380839},
    RWin=0.01992007523549354,
    RExtRem=0.015717058889806422,
    AFloor=41.467430094032565,
    alphaFloor=2.9999999999999996,
    nFloor=1,
    RFloor={0.0025680538828495155},
    RFloorRem=0.003920113298900598,
    CFloor={15970357.375188597},
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    floorRC(thermCapExt(each der_T(fixed=true))),
    nOrientations=7,
    AWin={3.552814950894916, 0.0, 0.0, 5.826827367481448, 0.0, 0.0, 0.6604804038330627},
    ATransparent={3.552814950894916, 0.0, 0.0, 5.826827367481448, 0.0, 0.0, 0.6604804038330627},
    AExt={26.272494113712064, 15.332679747447573, 15.332679747447573, 24.006392132335353, 12.777233122872978, 12.777233122872978, 35.052999346812506})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  IBPSA.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=7,
    wfGro=0.0,
    wfWall={0.27458764595851515, 0.05103540218060059, 0.05103540218060059, 0.2563620868607207, 0.042529501817167165, 0.042529501817167165, 0.2819204591852287},
    wfWin={0.35386170559806507, 0.0, 0.0, 0.5803541977223161, 0.0, 0.0, 0.06578409667961883},
    withLongwave=true,
    aExt=0.7924464352215616,
    alphaWallOut=15.628389253405485,
    alphaRad=5.7,
  ...
  IBPSA.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=21.328389253405486*141.55171133350103)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant alphaWin(k=11.399999999999999*10.040122722209427)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://ResidentialCommunityUK_rad_2elements_example/SemiDetached_3/SemiDetached_3_Models/InternalGains_SemiDetached_3House.mat"),
    columns={2,3,4})
