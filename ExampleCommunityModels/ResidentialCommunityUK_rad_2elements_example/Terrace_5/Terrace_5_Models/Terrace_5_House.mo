...
within ResidentialCommunityUK_rad_2elements_example.Terrace_5.Terrace_5_Models;
model Terrace_5_House
  "This is the simulation model of House within building Terrace_5 with traceable ID None"
  ...
  IBPSA.BoundaryConditions.SolarIrradiation.DiffusePerez HDifTil[6](
    ...
    azi = {1.7830106244211918, -2.929378355963498, 1.7830106244211918, -1.358582029168601, 0.2122142976262954, -1.358582029168601})
  ...
  thermalZoneThreeElements(
    ...
    VAir=182.53569651884303,
    alphaExt=3.6218703874836256,
    alphaWin=3.0,
    gWin=0.84,
    ratioWinConRad=0.03,
    nExt=1,
    RExt={0.001869972098194127},
    CExt={8010528.0877276575},
    alphaRad=5.956633535694694,
    AInt=174.45534966143487,
    alphaInt=3.000000000000001,
    nInt=1,
    RInt={0.000502739139772355},
    CInt={11894134.10800298},
    RWin=0.02067788295371973,
    RExtRem=0.03387365957784163,
    AFloor=39.68167315627023,
    alphaFloor=3.0,
    nFloor=1,
    RFloor={0.00268362159139311},
    RFloorRem=0.004096526463052169,
    CFloor={15282608.546370028},
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    floorRC(thermCapExt(each der_T(fixed=true))),
    nOrientations=6,
    AWin={3.092467881249907, 0.0, 0.0, 0.0, 0.0, 6.579702158963139},
    ATransparent={3.092467881249907, 0.0, 0.0, 0.0, 0.0, 6.579702158963139},
    AExt={24.96559280825305, 5.356832614855999, 15.931836885554647, 15.931836885554647, 5.356832614855999, 21.46362295717118})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  IBPSA.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=6,
    wfGro=0.0,
    wfWall={0.4390036839035716, 0.03839526304261857, 0.11419193242598777, 0.11419193242598777, 0.03839526304261857, 0.2558219251592157},
    wfWin={0.31972844443311604, 0.0, 0.0, 0.0, 0.0, 0.6802715555668839},
    withLongwave=true,
    aExt=0.7669814233527255,
    alphaWallOut=15.96128352975605,
  ...
  IBPSA.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=21.661283529756044*89.00655476624553)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant alphaWin(k=11.4*9.672170040213047)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://ResidentialCommunityUK_rad_2elements_example/Terrace_5/Terrace_5_Models/InternalGains_Terrace_5House.mat"),
    columns={2,3,4})
