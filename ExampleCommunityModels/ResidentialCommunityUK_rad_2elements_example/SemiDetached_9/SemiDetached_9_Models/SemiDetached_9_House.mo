...
within ResidentialCommunityUK_rad_2elements_example.SemiDetached_9.SemiDetached_9_Models;
model SemiDetached_9_House
  ...
  IBPSA.BoundaryConditions.SolarIrradiation.DiffusePerez HDifTil[7](
    each outSkyCon=true,
    each outGroCon=true,
    til={0.9599310885968813, 1.5707963267948966, 1.5707963267948966, 0.9599310885968813, 0.9599310885968813, 1.5707963267948966, 0.9599310885968813},
    each lat = 0.886452727088,
    azi = {-1.0877326262183766, -1.0877326262183766, 2.0538600273714165, 0.4830637005765198, -2.6585289530132736, 0.4830637005765198, 2.0538600273714165})
  ...
  thermalZoneThreeElements(
    ...
    alphaExt=3.493740674595202,
    alphaWin=2.9999999999999996,
    gWin=0.84,
    ratioWinConRad=0.029999999999999992,
    nExt=1,
    RExt={0.0010516658821578234},
    CExt={14440606.535304897},
    alphaRad=5.953254390841981,
    ...
    nOrientations=7,
    AWin={0.0, 5.797524850529603, 3.5019526153705165, 0.0, 0.0, 0.651024922370797, 0.0},
    ATransparent={0.0, 5.797524850529603, 3.5019526153705165, 0.0, 0.0, 0.651024922370797, 0.0},
    AExt={12.16646914889157, 24.574615527213595, 26.89828835655629, 14.599762978669885, 14.599762978669885, 35.94352894906852, 12.16646914889157})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  IBPSA.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=7,
    wfGro=0.0,
    wfWall={0.03731400466410053, 0.2602044478005344, 0.2793568397639104, 0.044776805596920634, 0.044776805596920634, 0.296257091913513, 0.03731400466410053},
    wfWin={0.0, 0.5826363960641218, 0.35193726695633154, 0.0, 0.0, 0.06542633697954667, 0.0},
    withLongwave=true,
    aExt=0.7981499920315599,
    alphaWallOut=15.557182127569487,
  ...
  IBPSA.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=21.257182127569482*140.9488970879613)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://ResidentialCommunityUK_rad_2elements_example/SemiDetached_9/SemiDetached_9_Models/InternalGains_SemiDetached_9House.mat"),
    columns={2,3,4})
