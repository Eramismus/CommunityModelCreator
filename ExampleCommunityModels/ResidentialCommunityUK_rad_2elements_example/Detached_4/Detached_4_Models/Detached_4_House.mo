...
within ResidentialCommunityUK_rad_2elements_example.Detached_4.Detached_4_Models;
model Detached_4_House
  "This is the simulation model of House within building Detached_4 with traceable ID None"
  ...
  IBPSA.BoundaryConditions.SolarIrradiation.DiffusePerez HDifTil[8](
    each outSkyCon=true,
    each outGroCon=true,
    til={1.5707963267948966, 1.5707963267948966, 0.9599310885968813, 0.9599310885968813, 0.9599310885968813, 1.5707963267948966, 1.5707963267948966, 0.9599310885968813},
    each lat = 0.886452727088,
    azi = {-2.843809318523785, 1.8685796618609047, -1.2730129917288884, 0.2977833350660081, 1.8685796618609047, 0.2977833350660081, -1.2730129917288884, -2.843809318523785})
  ...
  thermalZoneThreeElements(
    ...
    VAir=258.86991889772924,
    alphaExt=3.5290690373756237,
    alphaWin=2.9999999999999996,
    gWin=0.8399999999999999,
    ratioWinConRad=0.03,
    nExt=1,
    RExt={0.0007021676512379673},
    CExt={21343612.935631365},
    alphaRad=5.972018149665719,
    AInt=129.16193199821225,
    alphaInt=3.0,
    nInt=1,
    RInt={0.0008136815406490894},
    CInt={6986856.406977164},
    RWin=0.014787691709760771,
    RExtRem=0.009917240322455185,
    AFloor=53.02025724493832,
    alphaFloor=3.0,
    nFloor=1,
    RFloor={0.0020084888380079956},
    RFloorRem=0.0030659418235539915,
    CFloor={20419699.37384547},
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    floorRC(thermCapExt(each der_T(fixed=true))),
    nOrientations=8,
    AWin={7.587544418359602, 0.70277696147403, 0.0, 0.0, 0.0, 5.234439882803989, 0.0, 0.0},
    ATransparent={7.587544418359602, 0.70277696147403, 0.0, 0.0, 0.0, 5.234439882803989, 0.0, 0.0},
    AExt={25.375637806355673, 37.74366966147001, 27.068605301854546, 17.08212955942277, 27.068605301854546, 27.805178149701575, 37.74366966147001, 17.08212955942277})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  IBPSA.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=8,
    wfGro=0.0,
    wfWall={0.1358748288791552, 0.24161506329243065, 0.05900919550185818, 0.037238812695347394, 0.05900919550185818, 0.1883990281415724, 0.24161506329243065, 0.037238812695347394},
    wfWin={0.5610113384640897, 0.05196224523500191, 0.0, 0.0, 0.0, 0.3870264163009086, 0.0, 0.0},
    withLongwave=true,
    aExt=0.7893485838940602,
    alphaWallOut=15.668602348646198,
  ...
  IBPSA.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=21.3686023486462*216.9696250015519)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant alphaWin(k=11.399999999999999*13.524761262637622)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://ResidentialCommunityUK_rad_2elements_example/Detached_4/Detached_4_Models/InternalGains_Detached_4House.mat"),
    columns={2,3,4})
