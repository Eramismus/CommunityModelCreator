...
within ResidentialCommunityUK_rad_2elements_example.Terrace_2.Terrace_2_Models;
model Terrace_2_House
  "This is the simulation model of House within building Terrace_2 with traceable ID None"
  ...
  IBPSA.BoundaryConditions.SolarIrradiation.DiffusePerez HDifTil[6](
    each outSkyCon=true,
    each outGroCon=true,
    til={0.9599310885968813, 1.5707963267948966, 1.5707963267948966, 0.9599310885968813, 0.9599310885968813, 0.9599310885968813},
    each lat = 0.886452727088,
    azi = {-1.2090543938997529, -1.2090543938997529, 1.9325382596900407, 0.36174193289514395, -2.779850720694649, 1.9325382596900407})
  ...
  thermalZoneThreeElements(
    ...
    VAir=189.57117821360572,
    alphaExt=3.6214063455632672,
    alphaWin=2.9999999999999996,
    gWin=0.8400000000000001,
    ratioWinConRad=0.029999999999999995,
    nExt=1,
    RExt={0.0019390283883796754},
    CExt={7699309.602352829},
    alphaRad=5.968457191591604,
    AInt=186.6208275471302,
    alphaInt=3.000000000000001,
    nInt=1,
    RInt={0.00047488146554779196},
    CInt={12561027.429188194},
    RWin=0.019089986330003837,
    RExtRem=0.0323243059045993,
    AFloor=41.21112569860994,
    alphaFloor=3.0,
    nFloor=1,
    RFloor={0.00258402538294078},
    RFloorRem=0.003944493663475226,
    CFloor={15871646.826151704},
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    floorRC(thermCapExt(each der_T(fixed=true))),
    nOrientations=6,
    AWin={0.0, 6.961978210443037, 3.5147186578862466, 0.0, 0.0, 0.0},
    ATransparent={0.0, 6.961978210443037, 3.5147186578862466, 0.0, 0.0, 0.0},
    AExt={15.311294316903867, 20.62761818144621, 24.05706459643966, 5.148184817710334, 5.148184817710334, 15.311294316903867})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  IBPSA.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=6,
    wfGro=0.0,
    wfWall={0.10529537932814616, 0.27034303243356617, 0.44825833832617024, 0.03540393529198567, 0.03540393529198567, 0.10529537932814616},
    wfWin={0.0, 0.6645203443357106, 0.33547965566428933, 0.0, 0.0, 0.0},
    withLongwave=true,
    aExt=0.7668941313937715,
    alphaWallOut=15.959820012930306,
    alphaRad=5.7,
    alphaWinOut=5.7,
  ...
  IBPSA.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=21.659820012930304*85.60364104711427)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant alphaWin(k=11.4*10.476696868329284)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://ResidentialCommunityUK_rad_2elements_example/Terrace_2/Terrace_2_Models/InternalGains_Terrace_2House.mat"),
    columns={2,3,4})
