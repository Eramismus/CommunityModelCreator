...
within ResidentialCommunityUK_rad_2elements_example.Detached_2.Detached_2_Models;
model Detached_2_House
  "This is the simulation model of House within building Detached_2 with traceable ID None"
  ...
  IBPSA.BoundaryConditions.SolarIrradiation.DiffusePerez HDifTil[8](
    each outSkyCon=true,
    each outGroCon=true,
    til={1.5707963267948966, 0.9599310885968813, 0.9599310885968813, 1.5707963267948966, 0.9599310885968813, 1.5707963267948966, 0.9599310885968813, 1.5707963267948966},
    each lat = 0.886452727088,
    azi = {-2.079154596995033, 2.6332343833896568, 1.06243805659476, -0.5083582702001366, -0.5083582702001366, 2.6332343833896568, -2.079154596995033, 1.06243805659476})
  ...
  thermalZoneThreeElements(
    ...
    VAir=254.52123174688043,
    alphaExt=3.4849306166298164,
    alphaWin=3.0,
    gWin=0.8399999999999999,
    ratioWinConRad=0.029999999999999995,
    nExt=1,
    RExt={0.0006432688989589561},
    CExt={23634608.782364246},
    alphaRad=5.95355136118198,
    AInt=126.03342005175051,
    alphaInt=3.0,
    nInt=1,
    RInt={0.0008287477815636385},
    CInt={6873921.369922244},
    RWin=0.015664203325064678,
    RExtRem=0.009078726221952821,
    AFloor=50.911457626205305,
    alphaFloor=3.0,
    nFloor=1,
    RFloor={0.002091682301587806},
    RFloorRem=0.003192935966916336,
    CFloor={19607537.070383254},
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    floorRC(thermCapExt(each der_T(fixed=true))),
    nOrientations=8,
    AWin={0.6481979979743825, 0.0, 0.0, 7.291843450307002, 0.0, 4.8279235640199465, 0.0, 0.0},
    ATransparent={0.6481979979743825, 0.0, 0.0, 7.291843450307002, 0.0, 4.8279235640199465, 0.0, 0.0},
    AExt={41.95565203972405, 16.470776652793177, 26.09984608057996, 28.336049871930044, 16.470776652793177, 30.857700796950212, 26.09984608057996, 41.95565203972405})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  IBPSA.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=8,
    wfGro=0.0,
    wfWall={0.25001874407869124, 0.031318522510893974, 0.04962781259418585, 0.14473871772271224, 0.031318522510893974, 0.19333112390974572, 0.04962781259418585, 0.25001874407869124},
    wfWin={0.05076752617585295, 0.0, 0.0, 0.5711045921007503, 0.0, 0.3781278817233968, 0.0, 0.0},
    withLongwave=true,
    aExt=0.8008666428491813,
    alphaWallOut=15.52939656014019,
  ...
  IBPSA.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=21.22939656014019*228.2463002150746)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant alphaWin(k=11.4*12.767965012301332)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://ResidentialCommunityUK_rad_2elements_example/Detached_2/Detached_2_Models/InternalGains_Detached_2House.mat"),
    columns={2,3,4})
